<?php $__env->startSection('title', __('messages.forgot_password') . ' - Panchi Gallery'); ?>
<?php $__env->startSection('meta-description', __('messages.forgot_password_meta_description')); ?>
...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center">
            ...
            <h2 class="text-3xl font-bold text-gray-900"><?php echo e(__('messages.reset_password')); ?></h2>
            <p class="mt-2 text-sm text-gray-600">
                <?php echo e(__('messages.enter_email_reset')); ?>
            ...
            <?php if($errors->any()): ?>
                <div class="bg-red-50 border border-red-200 text-red-800 px-4 py-3 rounded-lg">
                    <div class="flex">
                        ...
                        <div>
                            <p class="font-medium"><?php echo e(__('messages.please_fix_error')); ?></p>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input id="email"
                           ...
                           placeholder="<?php echo e(__('messages.enter_email_address')); ?>">
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\panchigallery.com\resources\views\auth\forgot-password.blade.php ENDPATH**/ ?>