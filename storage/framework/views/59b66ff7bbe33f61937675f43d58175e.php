<?php $__env->startSection('title', 'Edit Profile - Panchi Gallery'); ?>
<?php $__env->startSection('meta-description', 'Edit your Panchi Gallery profile information.'); ?>
...
<div class="min-h-screen bg-gray-50 py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form action="<?php echo e(route('profile.update')); ?>" method="POST" enctype="multipart/form-data" class="bg-white rounded-xl shadow-sm">
            <?php echo csrf_field(); ?>
            ...
            <div class="p-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="location" name="location" value="<?php echo e(old('location', $user->location)); ?>"
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                        </div>
                        <div>
                            <label for="website" class="block text-sm font-medium text-gray-700 mb-2">Website</label>
                            <input type="url" id="website" name="website" value="<?php echo e(old('website', $user->website)); ?>" placeholder="https://example.com"
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-8 pb-8 border-b border-gray-100">
                    ...
                    <div>
                        ...
                        <textarea id="bio" name="bio" rows="4" maxlength="2000"
                                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"><?php echo e(old('bio', $user->bio)); ?></textarea>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <textarea id="artist_statement" name="artist_statement" rows="4" maxlength="2000"
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"><?php echo e(old('artist_statement', $user->artist_statement)); ?></textarea>
                        </div>
                        <div>
                            <label for="specialization" class="block text-sm font-medium text-gray-700 mb-2">Specialization</label>
                            <input type="text" id="specialization" name="specialization" value="<?php echo e(old('specialization', $user->specialization)); ?>"
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            ...
                            <textarea id="education" name="education" rows="3" maxlength="2000"
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"><?php echo e(old('education', $user->education)); ?></textarea>
                        </div>
                        <div>
                            ...
                            <textarea id="exhibitions" name="exhibitions" rows="3" maxlength="2000"
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"><?php echo e(old('exhibitions', $user->exhibitions)); ?></textarea>
                        </div>
                        <div>
                            ...
                            <textarea id="awards" name="awards" rows="3" maxlength="2000"
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"><?php echo e(old('awards', $user->awards)); ?></textarea>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <div class="flex flex-col sm:flex-row justify-between items-center gap-4 pt-4">
                    <a href="<?php echo e(route('profile')); ?>" class="text-gray-600 hover:text-gray-900 flex items-center gap-2">
                    ...
                    <div class="flex gap-4">
                        <a href="<?php echo e(route('profile')); ?>" class="px-6 py-3 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition">
                            Cancel
                        </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\panchigallery.com\resources\views\profile\edit.blade.php ENDPATH**/ ?>