<aside class="zoho-widgets-pane">
    ...
    <div class="zoho-widget-section">
        ...
        <a href="<?php echo e(route('admin.documents')); ?>" class="zoho-list-item" style="text-decoration:none;color:inherit;">
            <div class="zoho-list-icon">📄</div>
            <div class="zoho-list-content">
...
<?php /**PATH C:\xampp\htdocs\panchigallery.com\resources\views\admin\partials\widgets-pane.blade.php ENDPATH**/ ?>