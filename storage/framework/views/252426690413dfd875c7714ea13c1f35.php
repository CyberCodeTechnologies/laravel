<?php $__env->startSection('title', __('messages.checkout') . ' - ' . config('app.name')); ?>
<?php $__env->startSection('meta-keywords', 'checkout, buy art online, purchase artwork, art payment, art shipping, Myanmar art checkout, Panchi Gallery checkout, secure payment'); ?>
            ...
            <div class="w-full max-w-3xl">
                <div class="relative">
                    ...
                    <div class="relative flex justify-between">
                        ...
                        <div class="flex flex-col items-center step-item" data-step="<?php echo e($index + 1); ?>">
                            <div class="step-circle w-10 h-10 rounded-full flex items-center justify-center text-sm font-semibold transition-all duration-300 <?php echo e($index === 0 ? 'bg-black text-white ring-4 ring-gray-100' : 'bg-white text-gray-400 border-2 border-gray-300'); ?>" id="step-circle-<?php echo e($index + 1); ?>">
                                <i class="fas <?php echo e($step['icon']); ?>"></i>
                            </div>
                            <span class="mt-2 text-xs font-medium <?php echo e($index === 0 ? 'text-gray-900' : 'text-gray-500'); ?>" id="step-label-<?php echo e($index + 1); ?>"><?php echo e($step['label']); ?></span>
                        </div>
...
<section class="py-8 bg-gradient-to-b from-gray-50 to-white min-h-screen">
    <?php if($cart && $cart->items && $cart->items->count() > 0): ?>
        <form action="<?php echo e(auth()->check() ? route('checkout.process') : route('checkout.guest')); ?>" method="POST" id="checkout-form" class="checkout-form" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                    ...
                    <div class="xl:col-span-8 space-y-6">
                        ...
                        <div id="global-errors" class="hidden bg-red-50 border-l-4 border-red-500 p-4 rounded-lg shadow-sm">
                            <div class="flex items-start">
                                ...
                                <div class="flex-1">
                                    <h3 class="text-sm font-semibold text-red-800"><?php echo e(__('messages.please_fix_errors')); ?></h3>
                                    ...
                                    <?php if(!auth()->check()): ?>
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                            <div class="form-group">
                                                <label class="block text-sm font-medium text-gray-700 mb-1.5"><?php echo e(__('messages.email_address')); ?> <span class="text-red-500">*</span></label>
                                                <div class="relative">
                                                    ...
                                                    <input type="email" name="email" id="email" required value="<?php echo e(old('email')); ?>" class="pl-10 w-full px-3 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent focus:bg-white transition-all" placeholder="your@email.com">
                                                </div>
                                                <p class="mt-1 text-xs text-red-600 hidden" id="error-email"></p>
                                            </div>
                                            <div class="form-group">
                                                <label class="block text-sm font-medium text-gray-700 mb-1.5"><?php echo e(__('messages.phone_number')); ?> <span class="text-red-500">*</span></label>
                                                <div class="relative">
                                                    ...
                                                    <input type="tel" name="phone" id="phone" required value="<?php echo e(old('phone')); ?>" class="pl-10 w-full px-3 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent focus:bg-white transition-all" placeholder="+95 9 XXX XXX XXX">
                                                </div>
                                                <p class="mt-1 text-xs text-red-600 hidden" id="error-phone"></p>
                                            </div>
                                            <div class="form-group">
                                                <label class="block text-sm font-medium text-gray-700 mb-1.5"><?php echo e(__('messages.first_name')); ?> <span class="text-red-500">*</span></label>
                                                <div class="relative">
                                                    ...
                                                    <input type="text" name="first_name" id="first_name" required value="<?php echo e(old('first_name')); ?>" class="pl-10 w-full px-3 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent focus:bg-white transition-all" placeholder="John">
                                                </div>
                                                <p class="mt-1 text-xs text-red-600 hidden" id="error-first_name"></p>
                                            </div>
                                            <div class="form-group">
                                                <label class="block text-sm font-medium text-gray-700 mb-1.5"><?php echo e(__('messages.last_name')); ?> <span class="text-red-500">*</span></label>
                                                <div class="relative">
                                                    <span class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400"><i class="fas fa-user text-sm"></i></span>
                                                    <input type="text" name="last_name" id="last_name" required value="<?php echo e(old('last_name')); ?>" class="pl-10 w-full px-3 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent focus:bg-white transition-all" placeholder="Doe">
                                                </div>
                                                <p class="mt-1 text-xs text-red-600 hidden" id="error-last_name"></p>
                                            </div>
                                        </div>
                                        <div class="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-100">
                                            <p class="text-sm text-blue-700"><i class="fas fa-info-circle mr-2"></i><?php echo e(__('messages.already_have_account')); ?> <a href="<?php echo e(route('login')); ?>?redirect=<?php echo e(urlencode(url()->current())); ?>" class="font-semibold underline hover:text-blue-800"><?php echo e(__('messages.login_for_faster_checkout')); ?></a></p>
                                        </div>
                                    <?php else: ?>
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                            <div class="form-group">
                                                <label class="block text-sm font-medium text-gray-700 mb-1.5"><?php echo e(__('messages.email_address')); ?></label>
                                                <div class="relative">
                                                    <span class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400"><i class="fas fa-envelope text-sm"></i></span>
                                                    <input type="email" value="<?php echo e(auth()->user()->email); ?>" disabled class="pl-10 w-full px-3 py-2.5 bg-gray-100 border border-gray-200 rounded-lg text-gray-600 cursor-not-allowed">
                                                </div>
                                                <p class="mt-1 text-xs text-gray-500"><i class="fas fa-lock mr-1"></i><?php echo e(__('messages.secure_account_email')); ?></p>
                                            </div>
                                            <div class="form-group">
                                                <label class="block text-sm font-medium text-gray-700 mb-1.5"><?php echo e(__('messages.phone_number')); ?> <span class="text-red-500">*</span></label>
                                                <div class="relative">
                                                    <span class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400"><i class="fas fa-phone text-sm"></i></span>
                                                    <input type="tel" name="phone" id="phone" required value="<?php echo e(old('phone', auth()->user()->phone ?? '')); ?>" class="pl-10 w-full px-3 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent focus:bg-white transition-all" placeholder="+95 9 XXX XXX XXX">
                                                </div>
                                                <p class="mt-1 text-xs text-red-600 hidden" id="error-phone"></p>
                                            </div>
                                        </div>
                                ...
                                <div class="p-6 space-y-5">
                                    <div class="form-group">
                                        <label class="block text-sm font-medium text-gray-700 mb-1.5">
                                            <?php echo e(__('messages.street_address')); ?> <span class="text-red-500">*</span>
                                        </label>
                                        <div class="relative">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   class="pl-10 w-full px-3 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent focus:bg-white transition-all <?php $__errorArgs = ['address'];
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                                        <div class="form-group">
                                            <label class="block text-sm font-medium text-gray-700 mb-1.5">
                                                <?php echo e(__('messages.city')); ?> <span class="text-red-500">*</span>
                                            </label>
                                            <div class="relative">
                                                <span class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400">
                                                ...
                                                <input type="text" 
                                                       ...
                                                       class="pl-10 w-full px-3 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent focus:bg-white transition-all <?php $__errorArgs = ['city'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <div class="form-group">
                                            <label class="block text-sm font-medium text-gray-700 mb-1.5">
                                                <?php echo e(__('messages.state_province')); ?>
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="text" 
                                                       ...
                                                       class="pl-10 w-full px-3 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent focus:bg-white transition-all <?php $__errorArgs = ['state'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <div class="form-group">
                                            <label class="block text-sm font-medium text-gray-700 mb-1.5">
                                                <?php echo e(__('messages.zip_postal')); ?> <span class="text-red-500">*</span>
                                            </label>
                                            <div class="relative">
                                                <span class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400">
                                                ...
                                                <input type="text" 
                                                       ...
                                                       class="pl-10 w-full px-3 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent focus:bg-white transition-all <?php $__errorArgs = ['postal_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <div class="form-group">
                                            <label class="block text-sm font-medium text-gray-700 mb-1.5">
                                                <?php echo e(__('messages.country')); ?> <span class="text-red-500">*</span>
                                            </label>
                                            <div class="relative">
                                                <span class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-400">
                                                ...
                                                <select name="country" 
                                                        id="country"
                                                        required
                                                        class="pl-10 w-full px-3 py-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-transparent focus:bg-white transition-all <?php $__errorArgs = ['country'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                                    ...
                                                    <option value="MM" <?php echo e(old('country', auth()->user()->country ?? '') == 'MM' ? 'selected' : ''); ?>><?php echo e(__('messages.myanmar_country')); ?> (Myanmar)</option>
                                                    <option value="US" <?php echo e(old('country') == 'US' ? 'selected' : ''); ?>><?php echo e(__('messages.united_states')); ?> (USA)</option>
                                                    <option value="GB" <?php echo e(old('country') == 'GB' ? 'selected' : ''); ?>><?php echo e(__('messages.united_kingdom')); ?> (UK)</option>
                                                    <option value="SG" <?php echo e(old('country') == 'SG' ? 'selected' : ''); ?>><?php echo e(__('messages.singapore')); ?> (Singapore)</option>
                                                    <option value="TH" <?php echo e(old('country') == 'TH' ? 'selected' : ''); ?>><?php echo e(__('messages.thailand')); ?> (Thailand)</option>
                                                    <option value="JP" <?php echo e(old('country') == 'JP' ? 'selected' : ''); ?>><?php echo e(__('messages.japan') ?? 'Japan'); ?></option>
                                                    <option value="AU" <?php echo e(old('country') == 'AU' ? 'selected' : ''); ?>><?php echo e(__('messages.australia') ?? 'Australia'); ?></option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="flex items-center mt-4">
                                        <input type="checkbox" 
                                               ...
                                               id="save_address"
                                               value="1"
                                               <?php echo e(old('save_address') ? 'checked' : ''); ?>

                                               class="w-4 h-4 text-black border-gray-300 rounded focus:ring-black">
                                        <label for="save_address" class="ml-2 text-sm text-gray-600">
                                            <?php echo e(__('messages.save_address_future')); ?>
                            ...
                            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden mt-6">
                                <div class="bg-gradient-to-r from-gray-50 to-white px-6 py-4 border-b border-gray-100">
                                    <h2 class="text-lg font-semibold text-gray-900 flex items-center">
                                        ...
                                        <?php echo e(__('messages.shipping_method')); ?>
                                    ...
                                    <?php if(!$hasPhysicalItems): ?>
                                        <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    <h4 class="font-semibold text-green-800"><?php echo e(__('messages.digital_delivery')); ?></h4>
                                                    <p class="text-sm text-green-700">
                                                        <?php echo e(__('messages.digital_items_notice')); ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-5">
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    <h4 class="font-semibold text-green-800"><?php echo e(__('messages.free_shipping_unlocked')); ?></h4>
                                                    <p class="text-sm text-green-700">
                                                        <?php echo e(__('messages.free_shipping_message', ['amount' => $currencySymbol . number_format($freeShippingThreshold, 2)])); ?>
                                        ...
                                        <div class="space-y-3" id="shipping-methods">
                                            <?php $__currentLoopData = $shippingMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method => $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                            $isFree = $isFreeShippingEligible && $method === 'standard';
                                            $actualCost = $isFree ? 0 : $details['base_rate'];
                                            ?>
                                            <label class="shipping-option relative flex items-center p-4 border-2 rounded-xl cursor-pointer transition-all duration-200 <?php echo e($method === $defaultShippingMethod ? 'border-black bg-gray-50' : 'border-gray-200 hover:border-gray-300'); ?>"
                                                   data-method="<?php echo e($method); ?>"
                                                   data-cost="<?php echo e($actualCost); ?>">
                                                <input type="radio" 
                                                       name="shipping_method" 
                                                       value="<?php echo e($method); ?>" 
                                                       <?php echo e($method === $defaultShippingMethod ? 'checked' : ''); ?>
                                                ...
                                                <div class="flex-1 flex items-center">
                                                    ...
                                                    <div class="flex-1">
                                                        <div class="flex items-center justify-between">
                                                            <div>
                                                                <h3 class="font-semibold text-gray-900"><?php echo e($details['name']); ?></h3>
                                                                <p class="text-sm text-gray-500"><?php echo e($details['description']); ?></p>
                                                            </div>
                                                            <div class="text-right">
                                                                <?php if($isFree): ?>
                                                                    <span class="inline-block px-2 py-1 bg-green-100 text-green-700 text-xs font-semibold rounded-full mb-1">FREE</span>
                                                                    <p class="font-bold text-gray-900"><?php echo e($currencySymbol); ?>0.00</p>
                                                                <?php else: ?>
                                                                    <p class="font-bold text-gray-900"><?php echo e($currencySymbol); ?><?php echo e(number_format($actualCost, 2)); ?></p>
                                                                <?php endif; ?>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="ml-4 flex-shrink-0">
                                                    <div class="w-5 h-5 rounded-full border-2 flex items-center justify-center transition-colors <?php echo e($method === $defaultShippingMethod ? 'border-black bg-black' : 'border-gray-300'); ?>"
                                                         id="shipping-check-<?php echo e($method); ?>">
                                                        <?php if($method === $defaultShippingMethod): ?>
                            ...
                            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden mt-6">
                                <div class="bg-gradient-to-r from-gray-50 to-white px-6 py-4 border-b border-gray-100">
                                    <h2 class="text-lg font-semibold text-gray-900 flex items-center">
                                        ...
                                        <?php echo e(__('messages.order_notes')); ?> (<?php echo e(__('messages.optional')); ?>)
                                    </h2>
                                </div>
                                ...
                                <div class="p-6">
                                    <div class="form-group">
                                        <textarea name="order_notes" 
                                                  ...
                                                  placeholder="<?php echo e(__('messages.order_notes_placeholder')); ?>"></textarea>
                                    </div>
                                    ...
                                    <div class="mt-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                                        <div class="flex items-start">
                                            <input type="checkbox" 
                                                   ...
                                                   id="is_gift"
                                                   value="1"
                                                   <?php echo e(old('is_gift') ? 'checked' : ''); ?>
                                            ...
                                            <div class="ml-3 flex-1">
                                                <label for="is_gift" class="font-medium text-gray-900 cursor-pointer">
                                                    ...
                                                    <?php echo e(__('messages.this_is_gift')); ?>

                                                </label>
                                                <p class="text-sm text-gray-500 mt-1">
                                                    <?php echo e(__('messages.gift_note')); ?>

                                                </p>
                                                
                                                <!-- Gift Message (hidden by default) -->
                                                <div id="gift-message-container" class="mt-3 <?php echo e(old('is_gift') ? '' : 'hidden'); ?>">
                                                    <textarea name="gift_message" 
                                                              ...
                                                              placeholder="<?php echo e(__('messages.gift_message_placeholder')); ?>"
                                                              oninput="updateCharCount(this, 'gift-char-count')"><?php echo e(is_array(old('gift_message')) ? '' : old('gift_message')); ?></textarea>
                                                    <div class="flex justify-between mt-1">
                                                        <span class="text-xs text-gray-500"><?php echo e(__('messages.max_500_chars')); ?></span>
                                                ...
                                                <div class="mt-3 flex items-center">
                                                    ...
                                                    <label for="gift_receipt" class="ml-2 text-sm text-gray-600 cursor-pointer">
                                                        <?php echo e(__('messages.include_gift_receipt')); ?>
                            ...
                            <div class="flex justify-end pt-4">
                                <button type="button" 
                                        ...
                                        data-next="2">
                                    <?php echo e(__('messages.continue_to_payment') ?? 'Continue to Payment'); ?>
                        ...
                        <div class="checkout-step hidden" id="step-2">
                                ...
                                <div class="p-6">
                                    ...
                                    <?php if($paymentMethods->isEmpty()): ?>
                                        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                                            <p class="text-yellow-800">
                                                ...
                                                <?php echo e(__('messages.no_payment_methods')); ?>
                                    ...
                                    <?php else: ?>
                                        <div class="space-y-3">
                                            ...
                                            ?>
                                            <label class="payment-option payment-method-card relative flex items-center p-4 border-2 rounded-xl cursor-pointer transition-all duration-200 <?php echo e($index === 0 ? 'border-black bg-gray-50' : 'border-gray-200 hover:border-gray-300'); ?>"
                                                   data-method-id="<?php echo e($method->id); ?>"
                                                   data-requires-upload="<?php echo e($method->requires_manual_verification ? 'true' : 'false'); ?>"
                                                   data-method-code="<?php echo e($method->code); ?>"
                                                   data-type="<?php echo e($method->type); ?>"
                                                   data-instructions="<?php echo e($method->instructions); ?>">
                                                <input type="radio"
                                                       ...
                                                       data-requires-upload="<?php echo e($method->requires_manual_verification ? 'true' : 'false'); ?>"
                                                       data-method-code="<?php echo e($method->code); ?>"
                                                       data-method-name="<?php echo e($method->name); ?>">
                                                <div class="flex-1 flex items-center">
                                                    <div class="w-14 h-14 rounded-lg bg-white border border-gray-200 flex items-center justify-center mr-4 flex-shrink-0 shadow-sm">
                                                        <?php $__currentLoopData = $icons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <i class="<?php echo e($icon); ?> <?php echo e($method->type === 'stripe' ? 'text-blue-600 text-2xl mx-0.5' : ($method->type === 'paypal' ? 'text-blue-700 text-3xl' : 'text-gray-600 text-2xl')); ?>"></i>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </div>
                                                    <div class="flex-1">
                                                        <div class="flex items-center justify-between">
                                                                ...
                                                                <?php if($method->requires_manual_verification): ?>
                                                                    <div class="flex items-center mt-1">
                                                                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
                                                                            ...
                                                                            <?php echo e(__('messages.manual_verification')); ?>

                                                                        </span>
                                                                    </div>
                                                                    <p class="text-sm text-gray-500 mt-1">
                                                                        <?php echo e(__('messages.manual_payment_note')); ?>
                                                                ...
                                                                <?php else: ?>
                                                                    <div class="flex items-center mt-1">
                                                                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                                                            ...
                                                                            <?php echo e(__('messages.instant_processing')); ?>

                                                                        </span>
                                                                    </div>
                                                                    <p class="text-sm text-gray-500 mt-1">
                                                                        <?php echo e(__('messages.secure_payment_note')); ?>
                                                ...
                                                <div class="ml-4 flex-shrink-0">
                                                    <div class="w-5 h-5 rounded-full border-2 flex items-center justify-center transition-colors <?php echo e($index === 0 ? 'border-black bg-black' : 'border-gray-300'); ?>"
                                                         id="payment-check-<?php echo e($method->id); ?>">
                                                        <?php if($index === 0): ?>
                                                            <i class="fas fa-check text-white text-xs"></i>
                                                        <?php endif; ?>
                                                    </div>
                                        ...
                                        <div id="payment-screenshot-container" class="mt-4 hidden">
                                            <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                                                <div class="flex items-start mb-3">
                                                    ...
                                                    <div>
                                                        <h4 class="text-sm font-semibold text-yellow-800"><?php echo e(__('messages.upload_payment_screenshot')); ?></h4>
                                                        <p class="text-sm text-yellow-700 mt-1">
                                                            <?php echo e(__('messages.screenshot_upload_note')); ?>
                                                ...
                                                <div class="mt-3">
                                                    <div id="screenshot-upload-area" class="border-2 border-dashed border-yellow-300 rounded-lg p-6 text-center cursor-pointer hover:bg-yellow-100 transition-colors relative">
                                                        ...
                                                        <div id="screenshot-placeholder" class="pointer-events-none">
                                                            ...
                                                            <p class="text-sm text-yellow-700 font-medium"><?php echo e(__('messages.click_or_drag_screenshot')); ?></p>
                                                            <p class="text-xs text-yellow-600 mt-1"><?php echo e(__('messages.supported_formats')); ?></p>
                                                        </div>
                                                        ...
                                                        <div id="screenshot-preview" class="hidden pointer-events-none">
                                                            ...
                                                            <button type="button"
                                                                ...
                                                                <i class="fas fa-trash-alt mr-1"></i><?php echo e(__('messages.remove_screenshot')); ?>
                                                    ...
                                                    <p class="text-xs text-gray-500 mt-2">
                                                        ...
                                                        <?php echo e(__('messages.screenshot_optional_note')); ?>
                            ...
                            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden mt-6">
                                <div class="bg-gradient-to-r from-gray-50 to-white px-6 py-4 border-b border-gray-100">
                                    <h2 class="text-lg font-semibold text-gray-900 flex items-center">
                                        ...
                                        <?php echo e(__('messages.promo_code')); ?>
                                    ...
                                    <?php if($hasPromoCode): ?>
                                        <div class="bg-green-50 border border-green-200 rounded-lg p-4 flex items-center justify-between">
                                            <div class="flex items-center">
                                                ...
                                                <div>
                                                    <p class="font-semibold text-green-800"><?php echo e($cart->promo_code); ?></p>
                                                    <p class="text-sm text-green-600">
                                                        <?php echo e(__('messages.saved_amount', ['amount' => $cart->formatted_discount])); ?>
                            ...
                            <div class="flex justify-between pt-4">
                                <button type="button" 
                                    ...
                                    <?php echo e(__('messages.back_to_shipping') ?? 'Back to Shipping'); ?>

                                </button>
                                <button type="button" 
                                        class="btn-next-step bg-black text-white px-8 py-3 rounded-lg font-semibold hover:bg-gray-800 transition-all flex items-center shadow-lg hover:shadow-xl"
                                        data-next="3">
                                    <?php echo e(__('messages.review_order') ?? 'Review Order'); ?>
                        ...
                        <div class="checkout-step hidden" id="step-3">
                            ...
                            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                                <div class="bg-gradient-to-r from-gray-50 to-white px-6 py-4 border-b border-gray-100">
                                    <h2 class="text-lg font-semibold text-gray-900 flex items-center">
                                        ...
                                        <?php echo e(__('messages.review_your_order')); ?>
                                ...
                                <div class="p-6">
                                    ...
                                    <div class="space-y-6">
                                        ...
                                        <div class="review-section">
                                            <div class="flex items-center justify-between mb-3">
                                                <h3 class="font-semibold text-gray-900 flex items-center">
                                                    ...
                                                    <?php echo e(__('messages.contact_info')); ?>
                                            ...
                                            <div class="bg-gray-50 rounded-lg p-4 text-sm text-gray-700" id="review-contact">
                                                <p><span class="font-medium"><?php echo e(__('messages.email')); ?>:</span> <span id="review-email"><?php echo e(auth()->check() ? auth()->user()->email : ''); ?></span></p>
                                                <p class="mt-1"><span class="font-medium"><?php echo e(__('messages.phone')); ?>:</span> <span id="review-phone"></span></p>
                                                <?php if(!auth()->check()): ?>
                                                <p class="mt-1"><span class="font-medium"><?php echo e(__('messages.name')); ?>:</span> <span id="review-name"></span></p>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="review-section" id="review-notes-section" style="display: none;">
                                            <h3 class="font-semibold text-gray-900 mb-3 flex items-center">
                                                ...
                                                <?php echo e(__('messages.order_notes')); ?>
                                    ...
                                    <div class="mt-8 pt-6 border-t border-gray-200">
                                        <label class="flex items-start cursor-pointer">
                                            ...
                                            <span class="ml-3 text-sm text-gray-600">
                                                ...
                                                <a href="<?php echo e(route('terms')); ?>" target="_blank" class="text-indigo-600 hover:text-indigo-700 underline"><?php echo e(__('messages.terms_of_service_link')); ?></a>
                                                <?php echo e(__('messages.and')); ?>

                                                <a href="<?php echo e(route('privacy')); ?>" target="_blank" class="text-indigo-600 hover:text-indigo-700 underline"><?php echo e(__('messages.privacy_policy_link')); ?></a>.
                                                <?php echo e(__('messages.payment_terms_notice')); ?>

                                            </span>
                                        </label>
                                        <p class="mt-2 text-xs text-red-600 hidden" id="error-agree_terms">
                                            <?php echo e(__('messages.please_accept_terms')); ?>
                                    ...
                                    <div class="mt-6 bg-gray-900 text-white rounded-xl p-6">
                                        <div class="flex items-center justify-between">
                                            <div>
                                                <p class="text-gray-400 text-sm"><?php echo e(__('messages.total_amount')); ?></p>
                                                <p class="text-3xl font-bold" id="final-total"></p>
                                                <p class="text-gray-400 text-xs mt-1"><?php echo e(__('messages.including_taxes_shipping')); ?></p>
                                            </div>
                                            <button type="submit" 
                                                    id="place-order-btn"
                            ...
                            <div class="flex justify-between pt-4">
                                <button type="button" 
                                        ...
                                        data-prev="2">
                                    <i class="fas fa-arrow-left mr-2"></i>
                                    <?php echo e(__('messages.back_to_payment') ?? 'Back to Payment'); ?>
                    ...
                    <div class="xl:col-span-4">
                        <div class="sticky top-24 space-y-6">
                            ...
                            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                                <div class="bg-gradient-to-r from-gray-50 to-white px-6 py-4 border-b border-gray-100">
                                    <h2 class="text-lg font-semibold text-gray-900 flex items-center justify-between">
                                        <span><?php echo e(__('messages.order_summary')); ?></span>
                                        <span class="text-sm font-normal text-gray-500">(<?php echo e($cart->items->count()); ?> <?php echo e($cart->items->count() === 1 ? __('messages.item') : __('messages.items')); ?>)</span>
                                    </h2>
                                </div>
                                ...
                                <div class="p-6">
                                    ...
                                    <div class="space-y-4 max-h-80 overflow-y-auto" id="cart-items-list">
                                        ...
                                        <div class="flex items-start space-x-3 pb-4 border-b border-gray-100 last:border-0 last:pb-0 cart-item" data-item-id="<?php echo e($item->id); ?>">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <div class="flex justify-between items-start">
                                                    <h4 class="text-sm font-medium text-gray-900 truncate pr-2"><?php echo e($item->artwork_title); ?></h4>
                                                    <button type="button" 
                                                            onclick="removeCartItem(<?php echo e($item->id); ?>)"
                                                            class="text-gray-400 hover:text-red-500 transition-colors p-1"
                                                            title="<?php echo e(__('messages.remove')); ?>">
                                                        <i class="fas fa-times text-xs"></i>
                                                    </button>
                                                </div>
                                                <p class="text-xs text-gray-500"><?php echo e($item->artwork->artist->name ?? __('messages.unknown_artist')); ?></p>
                                                <?php if($item->artwork->is_digital): ?>
                                                    <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-800 mt-1">
                                                        <i class="fas fa-download mr-1"></i> <?php echo e(__('messages.digital')); ?>
                                                ...
                                                <div class="flex items-center justify-between mt-2">
                                                    <div class="flex items-center border border-gray-300 rounded-lg">
                                                        ...
                                                        <span class="px-2 text-sm font-medium text-gray-900 min-w-[2rem] text-center item-quantity"><?php echo e($item->quantity); ?></span>
                                                        <button type="button" 
                                                                onclick="updateQuantity(<?php echo e($item->id); ?>, 1)"
                                                                class="px-2 py-1 text-gray-600 hover:bg-gray-100 rounded-r-lg transition-colors disabled:opacity-50"
                                                                <?php echo e($item->quantity >= 99 || $item->quantity >= $item->artwork->stock ? 'disabled' : ''); ?>>
                                                            <i class="fas fa-plus text-xs"></i>
                                                        </button>
                                                    </div>
                                                    <span class="text-sm font-semibold text-gray-900 item-subtotal"><?php echo e($item->formatted_subtotal); ?></span>
                                                </div>
                                                
                                                <!-- Stock Warning -->
                                                <?php if($item->artwork->stock <= 5 && !$item->artwork->is_digital): ?>
                                                    <p class="text-xs text-amber-600 mt-1">
                                                        <i class="fas fa-exclamation-circle mr-1"></i>
                                                        <?php echo e(__('messages.only_x_left', ['count' => $item->artwork->stock]) ?? 'Only ' . $item->artwork->stock . ' left'); ?>
                                    ...
                                    <div class="mt-6 pt-6 border-t border-gray-200 space-y-3">
                                        <div class="flex justify-between text-sm">
                                            <span class="text-gray-600"><?php echo e(__('messages.subtotal')); ?></span>
                                            <span class="font-medium text-gray-900"><?php echo e($cart->formatted_subtotal ?? $cart->formatted_total); ?></span>
                                        </div>
                                        
                                        <?php if($hasPromoCode && $cart->discount_amount > 0): ?>
                                        <div class="flex justify-between text-sm">
                                            <span class="text-green-600 flex items-center">
                                                <i class="fas fa-tag mr-1"></i>
                                                <?php echo e(__('messages.discount')); ?> (<?php echo e($cart->promo_code); ?>)
                                            </span>
                                            <span class="font-medium text-green-600">-<?php echo e($cart->formatted_discount); ?></span>
                                        </div>
                                        <?php endif; ?>
                                        
                                        <div class="flex justify-between text-sm">
                                            <span class="text-gray-600"><?php echo e(__('messages.platform_fee')); ?></span>
                                            <span class="font-medium text-gray-900" id="summary-platform-fee"><?php echo e($currencySymbol); ?><?php echo e(number_format($subtotalAfterDiscount * $feeDecimal, 2)); ?></span>
                                        </div>
                                        
                                        <?php if($hasPhysicalItems): ?>
                                        <div class="flex justify-between text-sm">
                                            <span class="text-gray-600"><?php echo e(__('messages.shipping')); ?></span>
                                            <span class="font-medium text-gray-900" id="summary-shipping">
                                                <?php if($isFreeShippingEligible): ?>
                                                    <span class="text-green-600"><?php echo e(__('messages.free')); ?></span>
                                                <?php else: ?>
                                                    <?php echo e($currencySymbol); ?><?php echo e(number_format($shippingCost, 2)); ?>
                                        ...
                                        <div class="pt-4 border-t border-gray-200">
                                            <div class="flex justify-between">
                                                <span class="text-base font-semibold text-gray-900"><?php echo e(__('messages.total')); ?></span>
                                                <span class="text-xl font-bold text-gray-900" id="summary-total">
                                                    <?php echo e($currencySymbol); ?><?php echo e(number_format($subtotalAfterDiscount * $feeMultiplier + ($isFreeShippingEligible ? 0 : $shippingCost), 2)); ?> <?php echo e($currentCurrency !== 'USD' ? $currentCurrency : ''); ?>

                                                </span>
                                            </div>
                                            <p class="text-xs text-gray-500 mt-1 text-right">
                                                <?php echo e(__('messages.including_vat') ?? 'Including all taxes and fees'); ?>
                            ...
                            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                                <h3 class="text-sm font-semibold text-gray-900 mb-4"><?php echo e(__('messages.secure_checkout')); ?></h3>
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="flex items-center text-sm text-gray-600">
                                        <i class="fas fa-shield-alt text-green-600 mr-2"></i>
                                        <span><?php echo e(__('messages.ssl_encrypted')); ?></span>
                                    </div>
                                    <div class="flex items-center text-sm text-gray-600">
                                        <i class="fas fa-lock text-green-600 mr-2"></i>
                                        <span><?php echo e(__('messages.secure_payment')); ?></span>
                                    </div>
                                    <div class="flex items-center text-sm text-gray-600">
                                        <i class="fas fa-undo text-green-600 mr-2"></i>
                                        <span><?php echo e(__('messages.easy_returns')); ?></span>
                                    </div>
                                    <div class="flex items-center text-sm text-gray-600">
                                        <i class="fas fa-headset text-green-600 mr-2"></i>
                                        <span><?php echo e(__('messages.24_7_support')); ?></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-blue-50 rounded-xl border border-blue-100 p-6">
                                ...
                                <p class="text-sm text-blue-700 mb-3">
                                    <?php echo e(__('messages.help_text')); ?>

                                </p>
                                <a href="<?php echo e(route('contact')); ?>" class="inline-flex items-center text-sm font-semibold text-blue-800 hover:text-blue-900">
    ...
    <?php else: ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center py-16">
                ...
                <h2 class="text-3xl font-bold text-gray-900 mb-4"><?php echo e(__('messages.cart_empty')); ?></h2>
                <p class="text-gray-600 mb-8 max-w-md mx-auto text-lg">
                    <?php echo e(__('messages.cart_empty_message')); ?>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="<?php echo e(route('public.artworks.index')); ?>"
                       class="bg-black text-white px-8 py-3 rounded-lg font-semibold hover:bg-gray-800 transition-all inline-flex items-center justify-center shadow-lg hover:shadow-xl">
                        ...
                        <?php echo e(__('messages.browse_artworks')); ?>
                    ...
                    <a href="<?php echo e(route('home')); ?>"
                       class="border-2 border-gray-300 text-gray-700 px-8 py-3 rounded-lg font-semibold hover:bg-gray-50 transition-all inline-flex items-center justify-center">
                        ...
                        <?php echo e(__('messages.go_home')); ?>
...
<script>
    ...
    function getCurrencySymbol() {
        const currency = '<?php echo e($cart->currency); ?>';
        return currency === 'USD' ? '$' : '';
    }
    ...
    function updateReviewStep() {
        // Contact
        const email = document.getElementById('email')?.value || '<?php echo e(auth()->user()->email ?? ""); ?>';
        const phone = document.getElementById('phone')?.value || '';
        const firstName = document.getElementById('first_name')?.value || '<?php echo e(auth()->user()->first_name ?? ""); ?>';
        const lastName = document.getElementById('last_name')?.value || '<?php echo e(auth()->user()->last_name ?? ""); ?>';
        ...
        if (selectedPayment) {
            ...
            if (selectedPayment.dataset.requiresUpload === 'true') {
                paymentNote.textContent = '<?php echo e(__("messages.manual_verification_required")); ?>';
            } else {
                paymentNote.textContent = '<?php echo e(__("messages.instant_processing_secure")); ?>';
            }
        }
    ...
    function updateShippingCost(method, baseRate) {
        ...
        const subtotalAfterDiscount = <?php echo e($subtotalAfterDiscount); ?>;
        ...
        if (shippingElement) {
            if (isFreeShippingEligible) {
                shippingElement.innerHTML = '<span class="text-green-600"><?php echo e(__('messages.free')); ?></span>';
            } else {
        ...
        // Update total
        if (totalElement) {
            const feeMultiplier = <?php echo e($feeMultiplier); ?>;
            const total = subtotalAfterDiscount * feeMultiplier + actualCost;
            totalElement.textContent = currencySymbol + total.toFixed(2) + (currencySymbol !== '$' ? ' <?php echo e($currentCurrency); ?>' : '');
        }
    ...
    document.querySelectorAll('input[name="shipping_method"]').forEach(radio => {
        radio.addEventListener('change', function() {
            const costs = {
                'standard': <?php echo e($shippingMethods['standard']['base_rate'] ?? 50); ?>,
                'express': <?php echo e($shippingMethods['express']['base_rate'] ?? 100); ?>,
                'premium': <?php echo e($shippingMethods['premium']['base_rate'] ?? 200); ?>
    ...
    document.getElementById('checkout-form').addEventListener('submit', function(e) {
        ...
        submitButton.innerHTML = '<i class="fas fa-spinner fa-spin mr-2"></i> <?php echo e(__('messages.processing')); ?>';
            ...
            if (!response.ok) {
                ...
                if (contentType && contentType.includes('application/json')) {
                    ...
                    if (response.status === 419) {
                        throw { type: 'server', message: '<?php echo e(__('messages.csrf_token_expired')); ?>' };
                    } else if (response.status === 401 || response.status === 403) {
                        throw { type: 'server', message: '<?php echo e(__('messages.unauthorized')); ?>' };
                    } else {
                        throw { type: 'server', message: '<?php echo e(__('messages.server_error')); ?>' };
                    }
                }
            }
        ...
        .then(result => {
            if (result.success) {
                ...
                showToast(result.message || '<?php echo e(__('messages.error_occurred')); ?>', 'error');
            }
        })
        .catch(error => {
            ...
            if (error.type === 'validation' && error.data.errors) {
                ...
                showToast('<?php echo e(__('messages.please_fix_errors')); ?>', 'error');
            } else {
                showToast(error.message || '<?php echo e(__('messages.error_occurred')); ?>', 'error');
            }
        });
    });
    ...
    paymentMethodCards.forEach(card => {
        card.addEventListener('click', function() {
            ...
            if (requiresUpload && instructions) {
                ...
                paymentInstructionsTitle.textContent = radio.dataset.methodName + ' <?php echo e(__('messages.instructions')); ?>';
    ...
    function updateQuantity(itemId, change) {
        ...
        .then(data => {
            if (data.success) {
                ...
                showToast('<?php echo e(__('messages.quantity_updated')); ?>', 'success');
            } else {
                showToast(data.message || '<?php echo e(__('messages.error_occurred')); ?>', 'error');
                buttons.forEach(btn => btn.disabled = false);
            }
        })
        .catch(error => {
            console.error('Error:', error);
            showToast('<?php echo e(__('messages.error_occurred')); ?>', 'error');
            buttons.forEach(btn => btn.disabled = false);
        });
    }
    ...
    function removeCartItem(itemId) {
        if (!confirm('<?php echo e(__('messages.confirm_remove_item')); ?>')) {
            return;
        }
        ...
        fetch(`<?php echo e(route('checkout.cart.remove', ':itemId')); ?>`.replace(':itemId', itemId), {
            method: 'DELETE',
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
            }
        ...
        .then(data => {
            ...
            if (data.success) {
                if (data.cart_empty) {
                    ...
                    showToast('<?php echo e(__('messages.item_removed')); ?>', 'success');
                }
            } else {
    ...
    function updateCartSummary(cart, shippingCost) {
        ...
        if (itemCountEl) {
            itemCountEl.textContent = `(${cart.item_count} ${cart.item_count === 1 ? '<?php echo e(__('messages.item')); ?>' : '<?php echo e(__('messages.items')); ?>'})`;
        }
        ...
        if (discountEl && cart.discount !== '<?php echo e($currencySymbol); ?>0.00') {
    ...
    function validateField(field) {
        ...
        if (!value && field.hasAttribute('required')) {
            isValid = false;
            errorMsg = '<?php echo e(__('messages.field_required')); ?>';
        } else if (value) {
            switch (fieldName) {
                case 'email':
                    ...
                    if (!emailRegex.test(value)) {
                        isValid = false;
                        errorMsg = '<?php echo e(__('messages.invalid_email')); ?>';
                    }
                    break;
                case 'phone':
                    ...
                    if (!phoneRegex.test(value) || value.length < 8) {
                        isValid = false;
                        errorMsg = '<?php echo e(__('messages.invalid_phone')); ?>';
                    }
                    break;
                case 'postal_code':
                    if (value.length < 2 || value.length > 20) {
                        isValid = false;
                        errorMsg = '<?php echo e(__('messages.invalid_postal_code')); ?>';
                    }
                    break;
            }
        }
    ...
    document.querySelectorAll('.btn-next-step').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            if (validateStep(currentStep)) {
                ...
                showToast('<?php echo e(__('messages.please_fill_required')); ?>', 'error');
            }
        });
    });
    ...
    function handleScreenshotUpload(input) {
        ...
        if (file.size > maxSize) {
            showToast('<?php echo e(__('messages.file_too_large')); ?>', 'error');
            input.value = '';
            return;
        }
        ...
        if (!allowedTypes.includes(file.type)) {
            showToast('<?php echo e(__('messages.invalid_file_type')); ?>', 'error');
            input.value = '';
            return;
        }
        ...
        reader.onload = function(e) {
            ...
            showToast('<?php echo e(__('messages.screenshot_uploaded')); ?>', 'success');
        };
    ...
    function removeScreenshot(event) {
        ...
        showToast('<?php echo e(__('messages.screenshot_removed')); ?>', 'info');
    }
    ...
    if (applyPromoBtn) {
        applyPromoBtn.addEventListener('click', function() {
            ...
            if (!code) {
                promoError.textContent = '<?php echo e(__("messages.enter_promo_code") ?? "Please enter a promo code"); ?>';
            ...
            fetch('<?php echo e(route('cart.promo.apply')); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
            ...
            .then(data => {
                if (data.success) {
                    promoSuccess.textContent = data.message || '<?php echo e(__("messages.promo_applied")); ?>';
                    promoSuccess.classList.remove('hidden');
                    promoError.classList.add('hidden');
                    showToast(data.message || '<?php echo e(__("messages.promo_applied")); ?>', 'success');
                    
                    // Reload page to show updated totals
                    setTimeout(() => window.location.reload(), 1000);
                } else {
                    promoError.textContent = data.message || '<?php echo e(__("messages.invalid_promo")); ?>';
                    promoError.classList.remove('hidden');
                    promoSuccess.classList.add('hidden');
                    showToast(data.message || '<?php echo e(__("messages.invalid_promo")); ?>', 'error');
                }
            })
            .catch(error => {
                console.error('Error applying promo code:', error);
                promoError.textContent = '<?php echo e(__("messages.error_occurred")); ?>';
                promoError.classList.remove('hidden');
                showToast('<?php echo e(__("messages.error_occurred")); ?>', 'error');
            })
            .finally(() => {
                applyPromoBtn.disabled = false;
                applyPromoBtn.innerHTML = '<?php echo e(__("messages.apply")); ?>';
            });
        });
    }
    ...
    if (removePromoBtn) {
        removePromoBtn.addEventListener('click', function() {
            ...
            fetch('<?php echo e(route('cart.promo.remove')); ?>', {
                method: 'DELETE',
                headers: {
            ...
            .then(data => {
                if (data.success) {
                    showToast(data.message || '<?php echo e(__("messages.promo_removed")); ?>', 'success');
                    setTimeout(() => window.location.reload(), 1000);
                } else {
                    showToast(data.message || '<?php echo e(__("messages.error_occurred")); ?>', 'error');
                }
            ...
            .finally(() => {
                ...
                removePromoBtn.innerHTML = '<i class="fas fa-times mr-1"></i><?php echo e(__("messages.remove")); ?>';
            });
        });
    }
</script>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\panchigallery.com\resources\views\checkout\index.blade.php ENDPATH**/ ?>