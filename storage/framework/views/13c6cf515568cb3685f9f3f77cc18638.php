<?php $__env->startSection('title', 'Order Tracking - ' . $order->formatted_order_number); ?>
...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-8">
            ...
            <div class="relative">
                ...
                <?php $__currentLoopData = $timeline; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <div class="relative flex items-start mb-8 last:mb-0">
                        ...
                        <div class="ml-6 flex-1">
                            <div class="flex items-center justify-between mb-2">
                                <h3 class="text-lg font-semibold text-gray-900"><?php echo e($data['title']); ?></h3>
                                <?php if($data['time']): ?>
                                    <span class="text-sm text-gray-500">
                                        <?php echo e($data['time']->format('M j, Y g:i A')); ?>

                                    </span>
                                <?php endif; ?>
                            </div>
                            <p class="text-gray-600 <?php echo e($isPending ? 'text-gray-400' : ''); ?>">
                                <?php echo e($data['description']); ?>

                            </p>
                            
                            <?php if($isCurrent && $order->custom_status === 'pending_artist_approval'): ?>
                            ...
                            <?php if($isCurrent && $order->custom_status === 'in_progress'): ?>
                            ...
                            <?php if($isCurrent && $order->custom_status === 'ready_for_review'): ?>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-8">
                ...
                <div>
                    ...
                    <dl class="space-y-3">
                        <div class="flex justify-between">
                            ...
                            <dd class="text-sm font-medium text-gray-900"><?php echo e($order->title); ?></dd>
                        </div>
                        <div class="flex justify-between">
                            <dt class="text-sm text-gray-500">Artist</dt>
                            <dd class="text-sm font-medium text-gray-900"><?php echo e($order->artist->name); ?></dd>
                        </div>
                        <div class="flex justify-between">
                            <dt class="text-sm text-gray-500">Size</dt>
                            <dd class="text-sm font-medium text-gray-900"><?php echo e($order->size); ?></dd>
                        </div>
                        <div class="flex justify-between">
                            <dt class="text-sm text-gray-500">Medium</dt>
                            <dd class="text-sm font-medium text-gray-900"><?php echo e($order->medium); ?></dd>
                        </div>
                        <div class="flex justify-between">
                            <dt class="text-sm text-gray-500">Style</dt>
                            <dd class="text-sm font-medium text-gray-900"><?php echo e($order->style); ?></dd>
                        </div>
                        <div class="flex justify-between">
                            <dt class="text-sm text-gray-500">Budget</dt>
                            <dd class="text-sm font-medium text-gray-900">$<?php echo e(number_format($order->proposed_price, 2)); ?></dd>
                        </div>
                    </dl>
                </div>
                ...
                <div>
                    ...
                    <dl class="space-y-3">
                        <div class="flex justify-between">
                            ...
                            <dd class="text-sm font-medium text-gray-900"><?php echo e($order->user->name); ?></dd>
                        </div>
                        <div class="flex justify-between">
                            <dt class="text-sm text-gray-500">Email</dt>
                            <dd class="text-sm font-medium text-gray-900"><?php echo e($order->user->email); ?></dd>
                        </div>
                        <div class="flex justify-between">
                            <dt class="text-sm text-gray-500">Order Date</dt>
                            <dd class="text-sm font-medium text-gray-900"><?php echo e($order->created_at->format('M j, Y')); ?></dd>
                        </div>
                        <div class="flex justify-between">
            ...
            <?php if($order->customer_notes || $order->artist_notes): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\panchigallery.com\resources\views\orders\track.blade.php ENDPATH**/ ?>