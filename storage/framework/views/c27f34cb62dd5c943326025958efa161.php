...
<?php $__env->startSection('title', 'Create Shipment - Order #' . $order->order_number); ?>

<?php $__env->startSection('header', 'Create Shipment: Order #' . $order->order_number); ?>
                ...
                <form action="<?php echo e(route('admin.orders.update', $order->id)); ?>" method="POST" class="space-y-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="shipping_method" id="shipping_method" value="<?php echo e(old('shipping_method', $order->shipping_method ?? 'Standard Shipping')); ?>" 
                        ...
                        <div>
                            ...
                            <input type="text" name="tracking_number" id="tracking_number" value="<?php echo e(old('tracking_number')); ?>" 
                                   required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                        ...
                        <div>
                            ...
                            <textarea name="admin_notes" id="admin_notes" rows="3" 
                                      ...
                                      placeholder="Any internal notes about the shipment..."><?php echo e(old('admin_notes', $order->admin_notes)); ?></textarea>
                        </div>
                    </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\panchigallery.com\resources\views\admin\shipments\create.blade.php ENDPATH**/ ?>