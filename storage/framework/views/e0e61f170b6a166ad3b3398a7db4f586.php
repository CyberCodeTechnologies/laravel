...
<section class="bg-gray-900 text-white py-12">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p class="text-gray-300">List your artwork on the secondary marketplace</p>
    </div>
</section>
        ...
        <div class="bg-white rounded-lg shadow-sm p-8">
            ...
            <div class="flex gap-4 mb-8 p-4 bg-gray-50 rounded-lg">
                ...
                <div>
                    ...
                    <p class="text-gray-500 text-sm mt-1">Original Price: $<?php echo e(number_format($artwork->price, 2)); ?></p>
                </div>
            </div>

            <form action="<?php echo e(route('resales.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\panchigallery.com\resources\views\resales\create.blade.php ENDPATH**/ ?>