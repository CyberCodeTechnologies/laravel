...
<?php $__env->startSection('title', 'Create Page Content - Admin - Panchi Gallery'); ?>
<?php $__env->startSection('header', 'Create Page Content'); ?>

<?php $__env->startSection('admin_content'); ?>
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-lg shadow-sm p-6">
        <form action="<?php echo e(route('admin.page-contents.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <select id="page" name="page" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <option value="home" <?php echo e(old('page') == 'home' ? 'selected' : ''); ?>>Home</option>
                        <option value="about" <?php echo e(old('page') == 'about' ? 'selected' : ''); ?>>About</option>
                        <option value="contact" <?php echo e(old('page') == 'contact' ? 'selected' : ''); ?>>Contact</option>
                        <option value="faq" <?php echo e(old('page') == 'faq' ? 'selected' : ''); ?>>FAQ</option>
                        <option value="privacy" <?php echo e(old('page') == 'privacy' ? 'selected' : ''); ?>>Privacy Policy</option>
                        <option value="terms" <?php echo e(old('page') == 'terms' ? 'selected' : ''); ?>>Terms of Service</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" id="section" name="section" value="<?php echo e(old('section')); ?>" required
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea id="content_en" name="content_en" rows="4" required
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                              placeholder="Enter English content"><?php echo e(old('content_en')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea id="content_my" name="content_my" rows="4"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                              placeholder="Enter Myanmar content (optional)"><?php echo e(old('content_my')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select id="type" name="type" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <option value="image" <?php echo e(old('type') == 'image' ? 'selected' : ''); ?>>Image URL</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" id="sort_order" name="sort_order" min="0" value="<?php echo e(old('sort_order', 0)); ?>"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\panchigallery.com\resources\views\admin\page-contents\create.blade.php ENDPATH**/ ?>