...
<?php $__env->startSection('title', 'Pending Users - Admin'); ?>
<?php $__env->startSection('meta-description', 'Review and approve pending user registrations on Panchi Gallery'); ?>

<?php $__env->startSection('header', 'Pending Users'); ?>
            ...
            <div class="bg-yellow-50 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-yellow-900"><?php echo e(App\Models\User::where('is_approved', false)->count()); ?></p>
            ...
            <div class="bg-blue-50 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-blue-900"><?php echo e(App\Models\User::where('role', 'artist')->where('is_approved', false)->count()); ?></p>
            ...
            <div class="bg-green-50 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-green-900"><?php echo e(App\Models\User::where('role', 'collector')->where('is_approved', false)->count()); ?></p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <form method="GET" class="flex flex-wrap gap-3 items-center">
                ...
                <a href="<?php echo e(route('admin.users.pending')); ?>" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-300 transition">
            ...
            <div class="flex gap-3">
                ...
                <a href="<?php echo e(route('admin.users')); ?>" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">
...
function bulkApproveAll() {
    const pendingCount = <?php echo e($users->total()); ?>;
    if (pendingCount === 0) {
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\panchigallery.com\resources\views\admin\users\pending.blade.php ENDPATH**/ ?>