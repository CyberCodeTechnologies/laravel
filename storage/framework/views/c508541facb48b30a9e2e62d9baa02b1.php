<?php $__env->startSection('title', 'Verify Certificate - Panchi Gallery'); ?>
<?php $__env->startSection('meta-description', 'Verify the authenticity of artwork certificates.'); ?>
...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="bg-white rounded-lg shadow-lg p-8">
        ...
        <form action="<?php echo e(route('verify.certificate', ['certificate_code' => ''])); ?>" method="GET" class="space-y-6">
            <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\panchigallery.com\resources\views\verify\index.blade.php ENDPATH**/ ?>