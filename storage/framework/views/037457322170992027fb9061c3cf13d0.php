...
<?php $__env->startSection('title', 'Create User - Admin - Panchi Gallery'); ?>
<?php $__env->startSection('meta-description', 'Create a new user in Panchi Gallery admin panel'); ?>
    ...
    <div class="bg-white rounded-lg shadow-sm">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-blue-800 px-6 py-4 rounded-t-lg">
            <div class="flex justify-between items-center">
                ...
                <a href="<?php echo e(route('admin.users')); ?>" class="bg-white/20 text-white px-4 py-2 rounded-lg hover:bg-white/30 transition">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select id="role" 
                                ...
                                <option value="collector" <?php echo e(old('role') == 'collector' ? 'selected' : ''); ?>>Collector</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       id="years_active" 
                                       name="years_active" 
                                       value="<?php echo e(old('years_active')); ?>"
                                       min="0"
                                       max="100"
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="flex items-center pt-6">
                                <label class="flex items-center gap-3 cursor-pointer">
                                    <input type="checkbox"
                                           ...
                                           value="1"
                                           <?php echo e(old('participate_in_orders') ? 'checked' : ''); ?>
                        ...
                        <div>
                            ...
                            <textarea id="bio"
                                      ...
                                      rows="4"
                                      maxlength="1000"
                                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"><?php echo e(old('bio')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea id="artist_statement"
                                      ...
                                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"><?php echo e(old('artist_statement')); ?></textarea>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\panchigallery.com\resources\views\admin\users\create.blade.php ENDPATH**/ ?>