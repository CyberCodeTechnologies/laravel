<?php $__env->startSection('title', 'Resale Marketplace - Panchi Gallery'); ?>
<?php $__env->startSection('meta-description', 'Buy and sell pre-owned artworks in the Panchi Gallery resale marketplace. Find authenticated pieces from verified collectors.'); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            ...
            <div class="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
                <a href="<?php echo e(route('resales.create')); ?>" class="bg-white text-purple-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <aside class="lg:w-1/4">
                <div class="bg-white rounded-lg shadow-md p-6 sticky top-24">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="space-y-2">
                            <input type="range" 
                                   ...
                                   min="0" 
                                   max="10000" 
                                   value="<?php echo e(request('max_price', 10000)); ?>"
                                   class="w-full"
                                   id="price-slider">
                            <div class="flex justify-between text-sm text-gray-600">
                                <span>$0</span>
                                <span id="price-value">$<?php echo e(number_format(request('max_price', 10000))); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <a href="<?php echo e(route('resales.index')); ?>" class="block w-full text-center mt-2 text-gray-600 hover:text-gray-800">
                        Clear Filters
                    </a>
                </div>
            </aside>
            ...
            <main class="lg:w-3/4">
                ...
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h2 class="text-2xl font-semibold text-gray-900">
                            <?php if(isset($resales) && $resales->count() > 0): ?>
                                <?php echo e($resales->count()); ?> Resale Listings
                            <?php else: ?>
                                Browse Resale Listings
                            <?php endif; ?>
                        </h2>
                        <?php if(request()->hasAny(['search', 'categories', 'condition', 'max_price'])): ?>
                        ...
                        <?php $__currentLoopData = $resales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                                <div class="relative group">
                                    <a href="<?php echo e(route('resales.show', $resale->id)); ?>">
                                        <img src="<?php echo e($resale->primary_image); ?>" 
                                        ...
                                        <div class="absolute bottom-4 left-4 bg-black/70 text-white px-3 py-1 rounded-full text-sm font-medium">
                                            <?php echo e($resale->formatted_asking_price); ?>
                                ...
                                <div class="p-6">
                                    ...
                                    <p class="text-gray-600 mb-3">
                                        ...
                                        <?php if($resale->artwork->artist): ?>
                                            <a href="<?php echo e(route('public.artists.show', $resale->artwork->artist->slug ?? $resale->artwork->artist->id)); ?>" class="hover:text-purple-600">
                                                <?php echo e($resale->artwork->artist->name); ?>
                                    ...
                                    <div class="flex items-center justify-between mb-3">
                                        <div>
                                            <span class="text-lg font-bold text-purple-600"><?php echo e($resale->formatted_asking_price); ?></span>
                                            <?php if($resale->minimum_price): ?>
                                                <span class="text-sm text-gray-500 block">Min: <?php echo e($resale->formatted_minimum_price); ?></span>
                                            <?php endif; ?>
                                        </div>
                                        <div class="text-right">
                                            <span class="text-sm text-gray-500">Listed</span>
                                            <div class="text-xs text-gray-600"><?php echo e($resale->listed_at->diffForHumans()); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <span class="text-sm text-gray-600"><?php echo e($resale->owner->name); ?></span>
                                        </div>
                    ...
                    <?php else: ?>
                        ...
                        <?php for($i = 1; $i <= 6; $i++): ?>
                            <div class="bg-white rounded-lg overflow-hidden shadow-lg">
                                ...
                                <div class="p-6">
                                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Premium Artwork <?php echo e($i); ?></h3>
                ...
                <!-- Pagination -->
                <?php if(isset($resales) && $resales->hasPages()): ?>
                    <div class="mt-12">
...
<section class="py-20 bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
    <div class="max-w-4xl mx-auto text-center px-4">
        ...
        <a href="<?php echo e(route('resales.create')); ?>" class="bg-white text-purple-600 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors text-lg">
            Start Selling Today
        </a>
    </div>
</section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\panchigallery.com\resources\views\resales\index.blade.php ENDPATH**/ ?>