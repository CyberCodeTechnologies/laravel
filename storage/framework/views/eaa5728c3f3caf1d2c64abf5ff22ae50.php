<?php $__env->startSection('title', cms_content('home_title', __('messages.home_title'))); ?>
<?php $__env->startSection('meta-description', cms_content('home_meta_description', __('messages.home_meta_description'))); ?>
<?php $__env->startSection('meta-keywords', 'Panchi Gallery, Myanmar art gallery, buy art online, original artwork, contemporary art, traditional art, art marketplace, verified art certificates'); ?>
...
<section class="relative min-h-screen overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-black">
    ...
    <div class="absolute inset-0">
        <?php if($heroArtworks->count() > 0): ?>
            <?php $__currentLoopData = $heroArtworks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $artwork): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="absolute inset-0 transition-opacity duration-1000 ease-in-out <?php echo e($index === 0 ? 'opacity-100' : 'opacity-0'); ?>" data-slide="<?php echo e($index); ?>">
        ...
        <?php else: ?>
            <div class="absolute inset-0 bg-gradient-to-r from-black/70 via-black/50 to-transparent"></div>
            <img src="<?php echo e(asset('images/placeholder-artwork.jpg')); ?>" alt="Featured Artwork" class="w-full h-full object-cover">
        <?php endif; ?>
    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 w-full">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="inline-flex items-center bg-red-600/90 backdrop-blur-sm text-white px-4 py-2 rounded-full text-sm font-semibold mb-6 animate-pulse-soft">
                    ...
                    <?php echo e(__('messages.limited_time_offer')); ?>

                </div>
                <p class="text-elegant text-sm md:text-base font-medium text-white/80 mb-4 tracking-widest uppercase">
                    <?php echo e(cms_content('hero_premium_marketplace', __('messages.hero_premium_marketplace'))); ?>

                </p>
                <h1 class="font-serif text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-6 leading-tight">
                    <?php echo nl2br(e(cms_content('hero_title', __('messages.hero_title')))); ?>

                </h1>
                <p class="text-lg md:text-xl text-gray-300 mb-10 max-w-2xl leading-relaxed">
                    <?php echo e(cms_content('hero_description', __('messages.hero_description'))); ?>

                </p>
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="<?php echo e(route('public.artworks.index')); ?>" class="btn-luxury px-8 py-4 text-white font-medium rounded-lg text-lg text-center flex items-center justify-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/>
                        </svg>
                        <?php echo e(cms_content('shop_now', __('messages.shop_now'))); ?>
                    ...
                    <a href="#flash-sale" class="px-8 py-4 bg-red-600/90 backdrop-blur-sm border-2 border-red-500 text-white font-medium rounded-lg hover:bg-red-700 transition-all duration-300 text-lg text-center flex items-center justify-center">
                        ...
                        <?php echo e(cms_content('flash_sale', __('messages.flash_sale'))); ?>
                ...
                <div class="mt-8 flex flex-wrap items-center gap-4 text-white/80 text-sm">
                    <div class="flex items-center">
                        ...
                        <?php echo e(__('messages.verified_artists_badge')); ?>
                    ...
                    <div class="flex items-center">
                        ...
                        <?php echo e(__('messages.authentic_certificates')); ?>
                    ...
                    <div class="flex items-center">
                        ...
                        <?php echo e(__('messages.secure_payments')); ?>
                    ...
                    <div class="bg-white/10 backdrop-blur-md rounded-3xl p-6 border border-white/20 shadow-2xl hover:bg-white/15 transition-all duration-500 group">
                        <div class="flex items-center gap-2 mb-4">
                            <span class="bg-yellow-500 text-black text-xs font-bold px-3 py-1 rounded-full flex items-center gap-1">
                                ...
                                <?php echo e(__('messages.featured_of_week')); ?>

                            </span>
                        </div>
                        <div class="relative overflow-hidden rounded-2xl mb-4">
                            <img src="<?php echo e($featuredOfWeek->primary_image); ?>"
                                 alt="<?php echo e($featuredOfWeek->title); ?>"
                            ...
                            <div class="absolute top-3 right-3 bg-red-500 text-white text-xs font-bold px-3 py-1.5 rounded-full animate-pulse">
                                <?php echo e(__('messages.hot')); ?>

                            </div>
                        </div>
                        <h3 class="font-serif text-xl font-bold text-white mb-2"><?php echo e($featuredOfWeek->title); ?></h3>
                        <p class="text-white/70 text-sm mb-3">by <?php echo e($featuredOfWeek->artist->name ?? __('messages.unknown_artist')); ?></p>
                        <div class="flex items-center justify-between">
                            <div>
                                <span class="text-2xl font-bold text-white">$<?php echo e(number_format($featuredOfWeek->price)); ?></span>
                                <span class="text-white/50 text-sm line-through ml-2">$<?php echo e(number_format($featuredOfWeek->price * 1.15)); ?></span>
                            </div>
                            <a href="<?php echo e(route('public.artworks.show', $featuredOfWeek)); ?>" class="bg-white text-black px-5 py-2.5 rounded-xl font-medium hover:bg-gray-100 transition-colors flex items-center gap-2 group-hover:shadow-lg">
    ...
    <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex space-x-3 z-20">
        <?php if($heroArtworks->count() > 0): ?>
            <?php $__currentLoopData = $heroArtworks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $artwork): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button
                    class="h-1 rounded-full bg-white/40 hover:bg-white transition-all duration-300 <?php echo e($index === 0 ? 'w-12 bg-white' : 'w-8'); ?>"
                    onclick="goToSlide(<?php echo e($index); ?>)"
                    data-indicator="<?php echo e($index); ?>">
                </button>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endif; ?>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="text-center md:text-left">
                <div class="flex flex-wrap items-center gap-2 mb-3 justify-center md:justify-start">
                    <div class="inline-flex items-center bg-white/20 backdrop-blur-sm text-white px-3 py-1 rounded-full text-xs font-semibold animate-pulse">
                        ...
                        <?php echo e(__('messages.limited_time_offer_badge')); ?>
                    ...
                    <div class="inline-flex items-center bg-black/30 backdrop-blur-sm text-white px-3 py-1 rounded-full text-xs font-semibold">
                        ...
                        <?php echo e(__('messages.only_pieces_left')); ?>

                    </div>
                </div>
                <h2 class="font-serif text-3xl md:text-4xl font-bold text-white mb-2">
                    <?php echo e(__('messages.flash_sale_title')); ?>

                </h2>
                <p class="text-white/90 text-lg"><?php echo e(__('messages.flash_sale_description')); ?></p>
            </div>
            <div class="flex items-center gap-2 md:gap-4">
                <div class="text-center">
                    <div class="bg-white/20 backdrop-blur-sm rounded-lg px-3 md:px-4 py-3 border border-white/30">
                        ...
                        <span class="text-white/80 text-xs uppercase"><?php echo e(__('messages.hours')); ?></span>
                    </div>
                </div>
                ...
                <div class="text-center">
                    <div class="bg-white/20 backdrop-blur-sm rounded-lg px-3 md:px-4 py-3 border border-white/30">
                        ...
                        <span class="text-white/80 text-xs uppercase"><?php echo e(__('messages.minutes')); ?></span>
                    </div>
                </div>
                <span class="text-white text-2xl md:text-3xl font-bold animate-pulse">:</span>
                <div class="text-center">
                    <div class="bg-white/20 backdrop-blur-sm rounded-lg px-3 md:px-4 py-3 border border-white/30 relative overflow-hidden">
                        ...
                        <span class="text-white/80 text-xs uppercase"><?php echo e(__('messages.seconds')); ?></span>
                    </div>
                </div>
            </div>
            <a href="<?php echo e(route('public.artworks.index')); ?>?sort=discount" class="px-8 py-4 bg-white text-red-600 font-semibold rounded-lg hover:bg-gray-100 transition-all duration-300 text-center shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                <?php echo e(__('messages.shop_flash_sale')); ?>
        ...
        <div class="mt-8 max-w-md mx-auto md:mx-0">
            <div class="flex justify-between text-white/80 text-sm mb-2">
                <span><?php echo e(__('messages.selling_fast')); ?></span>
                <span><?php echo e(__('messages.percent_sold')); ?></span>
            </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div class="flex items-center justify-center gap-3">
                ...
                <div>
                    <p class="font-semibold text-gray-900"><?php echo e(__('messages.authentic_100')); ?></p>
                    <p class="text-sm text-gray-500"><?php echo e(__('messages.verified_artworks')); ?></p>
                </div>
            </div>
            <div class="flex items-center justify-center gap-3">
                ...
                <div>
                    <p class="font-semibold text-gray-900"><?php echo e(__('messages.secure_payment')); ?></p>
                    <p class="text-sm text-gray-500"><?php echo e(__('messages.encrypted_transactions')); ?></p>
                </div>
            </div>
            <div class="flex items-center justify-center gap-3">
                ...
                <div>
                    <p class="font-semibold text-gray-900"><?php echo e(__('messages.free_shipping')); ?></p>
                    <p class="text-sm text-gray-500"><?php echo e(__('messages.on_orders_over')); ?></p>
                </div>
            </div>
            <div class="flex items-center justify-center gap-3">
                ...
                <div>
                    <p class="font-semibold text-gray-900"><?php echo e(__('messages.day_returns')); ?></p>
                    <p class="text-sm text-gray-500"><?php echo e(__('messages.hassle_free_policy')); ?></p>
                </div>
            </div>
        </div>
    </div>
...
<section id="featured" class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="inline-flex items-center bg-red-100 text-red-600 px-4 py-2 rounded-full text-sm font-semibold mb-4">
                ...
                <?php echo e(__('messages.best_sellers')); ?>

            </div>
            <h2 class="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4">
                <?php echo e(__('messages.featured_artworks_title')); ?>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                ...
                <?php $__currentLoopData = $featuredArtworks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $artwork): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="group cursor-pointer card-elegant rounded-2xl overflow-hidden bg-white shadow-sm hover:shadow-xl transition-all duration-300">
                        <div class="relative overflow-hidden">
                            ...
                            <!-- Wishlist Button -->
                            <button onclick="event.preventDefault(); addToWishlist(<?php echo e($artwork->id); ?>)" class="absolute top-4 right-4 w-10 h-10 bg-white/95 backdrop-blur-sm rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 shadow-lg hover:bg-red-50 hover:scale-110">
                            ...
                            <div class="absolute bottom-4 left-4 right-4 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-4 group-hover:translate-y-0">
                                <a href="<?php echo e(route('public.artworks.show', $artwork)); ?>" class="w-full bg-white text-black py-3 rounded-xl text-sm font-semibold text-center block hover:bg-gray-100 transition-colors shadow-lg flex items-center justify-center gap-2">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                    </svg>
                                    <?php echo e(__('messages.quick_view')); ?>
                        ...
                        <div class="p-5 md:p-6">
                            <div class="flex items-center gap-2 mb-2">
                                <span class="bg-green-100 text-green-700 text-xs font-semibold px-2 py-1 rounded-full"><?php echo e(__('messages.in_stock')); ?></span>
                                <span class="text-xs text-gray-400"><?php echo e($artwork->views_count ?? 0); ?> <?php echo e(__('messages.views')); ?></span>
                            </div>
                            <h3 class="font-serif text-lg md:text-xl font-semibold text-gray-900 mb-1 group-hover:text-black transition-colors line-clamp-1"><?php echo e($artwork->title); ?></h3>
                            <?php if($artwork->artist): ?>
                                <a href="<?php echo e(route('public.artists.show', $artwork->artist->slug ?? $artwork->artist->id)); ?>" class="text-gray-600 text-sm hover:text-black transition-colors mb-3 inline-block"><?php echo e($artwork->artist->name); ?></a>
                            <?php else: ?>
                                <span class="text-gray-600 text-sm mb-3 inline-block"><?php echo e(__('messages.unknown_artist')); ?></span>
                            <?php endif; ?>
                            <div class="flex items-center justify-between pt-3 border-t border-gray-100">
                                <div>
                                    <span class="text-xl md:text-2xl font-bold text-black">$<?php echo e(number_format($artwork->price)); ?></span>
                                    <span class="text-xs md:text-sm text-gray-400 line-through ml-2">$<?php echo e(number_format($artwork->price * 1.2)); ?></span>
                                </div>
                                <a href="<?php echo e(route('public.artworks.show', $artwork)); ?>" class="btn-luxury px-3 md:px-4 py-2 text-white text-sm font-medium rounded-lg hover:shadow-lg transition-shadow">
            ...
            <?php else: ?>
                <div class="col-span-full text-center text-gray-500 py-12">
                    <?php echo e(__('messages.no_featured_artworks')); ?>
        ...
        <div class="text-center mt-16">
            <a href="<?php echo e(route('public.artworks.index')); ?>" class="inline-flex items-center px-8 py-4 border-2 border-black text-black font-medium rounded-lg hover:bg-black hover:text-white transition-all duration-300">
...
<section class="py-24 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between mb-8">
            <div>
                <div class="inline-flex items-center bg-blue-100 text-blue-600 px-4 py-2 rounded-full text-sm font-semibold mb-3">
                    ...
                    <?php echo e(__('messages.just_arrived')); ?>

                </div>
                <h2 class="font-serif text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900">
                    <?php echo e(__('messages.new_arrivals_title')); ?>
        ...
        <div id="newArrivalsContainer" class="flex gap-6 overflow-x-auto scrollbar-hide scroll-smooth pb-4" style="scroll-behavior: smooth; -ms-overflow-style: none; scrollbar-width: none;">
            <?php if($trendingArtworks->count() > 0): ?>
                <?php $__currentLoopData = $trendingArtworks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $artwork): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="group cursor-pointer flex-shrink-0 w-64 md:w-72">
                        <div class="relative rounded-xl overflow-hidden mb-3 shadow-md group-hover:shadow-xl transition-all duration-300">
                            ...
                            <div class="absolute top-3 left-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white px-3 py-1.5 rounded-full text-xs font-bold shadow-lg animate-pulse">
                                <span class="flex items-center gap-1">
                                    ...
                                    <?php echo e(__('messages.new_badge')); ?>
                            ...
                            <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                <div class="absolute bottom-4 left-4 right-4">
                                    <a href="<?php echo e(route('public.artworks.show', $artwork)); ?>" class="w-full bg-white text-black py-2 rounded-lg text-sm font-medium text-center block hover:bg-gray-100 transition-colors">
                                        <?php echo e(__('messages.quick_view')); ?>
                        ...
                        <h4 class="font-medium text-gray-900 group-hover:text-black transition-colors mb-1 truncate"><?php echo e($artwork->title); ?></h4>
                        <p class="text-sm text-gray-600 mb-1"><?php echo e($artwork->artist->name ?? __('messages.unknown_artist')); ?></p>
                        <p class="font-semibold text-black">$<?php echo e(number_format($artwork->price)); ?></p>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php else: ?>
                <div class="text-center text-gray-500 py-12 flex-shrink-0 w-full">
                    <?php echo e(__('messages.no_new_arrivals')); ?>
...
<section class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <p class="text-elegant text-sm font-medium text-gray-500 mb-3 tracking-widest uppercase"><?php echo e(__('messages.creative_minds')); ?></p>
            <h2 class="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4">
                <?php echo e(__('messages.featured_artists_title')); ?>

            </h2>
            <p class="text-xl text-gray-600 max-w-2xl mx-auto">
                <?php echo e(__('messages.featured_artists_description')); ?>

            </p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <?php if($featuredArtists->count() > 0): ?>
                <?php $__currentLoopData = $featuredArtists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $artist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="text-center group cursor-pointer bg-gray-50 rounded-2xl p-6 hover:bg-gray-100 transition-all duration-300 hover:shadow-lg">
                        <div class="relative mb-6 mx-auto w-32 h-32">
                            ...
                            <img src="<?php echo e($artist->avatar_url); ?>" alt="<?php echo e($artist->name); ?>" class="relative w-32 h-32 rounded-full object-cover ring-4 ring-white shadow-xl group-hover:shadow-2xl transition-all duration-300">
                        ...
                        <h3 class="font-serif text-xl font-semibold text-gray-900 mb-2 group-hover:text-black transition-colors"><?php echo e($artist->name); ?></h3>
                        ...
                        <p class="text-gray-600 mb-4 px-2 text-sm leading-relaxed line-clamp-2"><?php echo e($artist->bio ?? __('messages.artist_bio_default')); ?></p>

                        <div class="flex items-center justify-center space-x-3 mb-4 text-sm">
                            <span class="bg-gray-200 text-gray-700 px-3 py-1 rounded-full"><?php echo e($artist->artworks_count ?? 0); ?> <?php echo e(__('messages.artworks')); ?></span>
                            <?php if($artist->years_active): ?>
                                <span class="bg-gray-200 text-gray-700 px-3 py-1 rounded-full"><?php echo e($artist->years_active); ?>+ <?php echo e(__('messages.years')); ?></span>
                            <?php endif; ?>
                        </div>

                        <a href="<?php echo e(route('public.artists.show', $artist->slug ?? $artist->id)); ?>" class="inline-flex items-center px-6 py-2.5 bg-black text-white rounded-lg font-medium hover:bg-gray-800 transition-colors group-hover:shadow-lg">
                            <?php echo e(__('messages.view_portfolio')); ?>
            ...
            <?php else: ?>
                <div class="col-span-3 text-center text-gray-500 py-12">
                    <?php echo e(__('messages.no_featured_artists')); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <div class="inline-flex items-center bg-yellow-100 text-yellow-700 px-4 py-2 rounded-full text-sm font-semibold mb-4">
                ...
                <?php echo e(__('messages.loved_by_collectors')); ?>

            </div>
            <h2 class="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4">
                <?php echo e(__('messages.customer_reviews_title')); ?>

            </h2>
            <p class="text-xl text-gray-600 max-w-2xl mx-auto">
                <?php echo e(__('messages.customer_reviews_description')); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <p class="text-gray-700 mb-6 leading-relaxed">"<?php echo e(__('messages.testimonial_1_text')); ?>"</p>
                <div class="flex items-center">
                    ...
                    <div class="flex-1">
                        <p class="font-semibold text-gray-900"><?php echo e(__('messages.testimonial_1_author')); ?></p>
                        <p class="text-sm text-gray-500 flex items-center gap-1">
                            <span class="text-lg">🇺🇸</span> <?php echo e(__('messages.testimonial_1_role')); ?>
            ...
            <div class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <p class="text-gray-700 mb-6 leading-relaxed">"<?php echo e(__('messages.testimonial_2_text')); ?>"</p>
                <div class="flex items-center">
                    ...
                    <div class="flex-1">
                        <p class="font-semibold text-gray-900"><?php echo e(__('messages.testimonial_2_author')); ?></p>
                        <p class="text-sm text-gray-500 flex items-center gap-1">
                            <span class="text-lg">🇬🇧</span> <?php echo e(__('messages.testimonial_2_role')); ?>
            ...
            <div class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <p class="text-gray-700 mb-6 leading-relaxed">"<?php echo e(__('messages.testimonial_3_text')); ?>"</p>
                <div class="flex items-center">
                    ...
                    <div class="flex-1">
                        <p class="font-semibold text-gray-900"><?php echo e(__('messages.testimonial_3_author')); ?></p>
                        <p class="text-sm text-gray-500 flex items-center gap-1">
                            <span class="text-lg">🇸🇬</span> <?php echo e(__('messages.testimonial_3_role')); ?>
...
<section class="py-24 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <p class="text-elegant text-sm font-medium text-gray-500 mb-3 tracking-widest uppercase"><?php echo e(__('messages.themed_collections')); ?></p>
            <h2 class="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4">
                <?php echo e(__('messages.curated_collections')); ?>

            </h2>
            <p class="text-xl text-gray-600 max-w-2xl mx-auto">
                <?php echo e(__('messages.explore_carefully_selected_collections')); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="group cursor-pointer rounded-2xl overflow-hidden bg-white shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                        <div class="relative h-64 overflow-hidden">
                            <img src="<?php echo e($category->image ? asset('storage/' . $category->image) : asset('images/placeholder-category.jpg')); ?>"
                            ...
                            <div class="absolute inset-0 flex flex-col justify-end p-6">
                                <div class="transform group-hover:translate-y-0 transition-transform duration-500">
                                    <span class="inline-block bg-white/20 backdrop-blur-sm text-white text-xs font-semibold px-3 py-1 rounded-full mb-3 transform -translate-y-2 opacity-0 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 delay-100">
                                        <?php echo e($category->artworks_count ?? 0); ?> <?php echo e(__('messages.artworks_count')); ?>
                                    ...
                                    <p class="text-white/80 text-sm line-clamp-2 transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 delay-150">
                                        <?php echo e($category->description ?? 'Explore this curated collection of authentic artworks'); ?>
                        ...
                        <a href="<?php echo e(route('categories.show', $category)); ?>" class="block p-6 bg-white hover:bg-gray-50 transition-colors">
                            <div class="flex items-center justify-between">
                                <span class="text-gray-600 text-sm"><?php echo e(__('messages.explore_collection')); ?></span>
            ...
            <?php else: ?>
                <div class="col-span-full text-center text-gray-500 py-12">
                    <?php echo e(__('messages.no_collections_available')); ?>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="animate-fade-in-up">
            <div class="inline-flex items-center bg-red-600/90 backdrop-blur-sm text-white px-4 py-2 rounded-full text-sm font-semibold mb-6 animate-pulse-soft">
                ...
                <?php echo e(__('messages.get_10_off_first_order')); ?>

            </div>
            <p class="text-elegant text-sm font-medium text-white/60 mb-3 tracking-widest uppercase"><?php echo e(__('messages.stay_connected')); ?></p>
            <h2 class="font-serif text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
                <?php echo e(__('messages.stay_inspired')); ?>

            </h2>
            <p class="text-xl text-gray-300 mb-10 max-w-2xl mx-auto leading-relaxed">
                <?php echo e(__('messages.stay_inspired_description')); ?>

            </p>
            <form action="<?php echo e(route('newsletter.subscribe')); ?>" method="POST" class="flex flex-col sm:flex-row gap-4 max-w-lg mx-auto">
                <?php echo csrf_field(); ?>
                <input
                    type="email"
                    name="email"
            ...
            <p class="text-sm text-gray-400 mt-6">
                <?php echo e(__('messages.join_art_enthusiasts')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\panchigallery.com\resources\views\home.blade.php ENDPATH**/ ?>