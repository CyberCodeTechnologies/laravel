<?php $__env->startSection('title', 'My Custom Orders - Customer Dashboard'); ?>
    ...
    <div class="bg-white border-b border-gray-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div class="flex flex-wrap gap-4">
                ...
                <a href="<?php echo e(route('orders.customer.index', ['status' => 'pending_artist_approval'])); ?>" 
                ...
                <a href="<?php echo e(route('orders.customer.index', ['status' => 'artist_accepted'])); ?>" 
                ...
                <a href="<?php echo e(route('orders.customer.index', ['status' => 'in_progress'])); ?>" 
                ...
                <a href="<?php echo e(route('orders.customer.index', ['status' => 'ready_for_review'])); ?>" 
                ...
                <a href="<?php echo e(route('orders.customer.index', ['status' => 'delivered'])); ?>" 
                        ...
                        <div class="p-6">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                                <div>
                                    ...
                                    <div class="font-medium text-gray-900"><?php echo e($order->artist->name); ?></div>
                                </div>
                                <div>
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <?php if(!$loop->last): ?>
                                                <div class="w-8 h-1 <?php echo e($isCompleted ? 'bg-green-500' : 'bg-gray-300'); ?>"></div>
                                            <?php endif; ?>
                                        </div>
        ...
        <?php else: ?>
            <div class="text-center py-12">
                ...
                <p class="mt-1 text-sm text-gray-500">
                    <?php echo e(request('status') ? 'No orders found with this status.' : 'You haven\'t placed any custom orders yet.'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\panchigallery.com\resources\views\orders\customer\index.blade.php ENDPATH**/ ?>