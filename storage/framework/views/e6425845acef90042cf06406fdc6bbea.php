...
<?php $__env->startSection('title', 'Images Settings - Admin'); ?>
<?php $__env->startSection('header', 'Images Settings'); ?>
...
<section class="py-8 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold"><?php echo e($groupedSettings->flatten()->count()); ?></p>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-lg shadow p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold"><?php echo e($groupedSettings->flatten()->whereNotNull('value')->count()); ?></p>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-lg shadow p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold"><?php echo e($groupedSettings->flatten()->whereNull('value')->count()); ?></p>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-lg shadow p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold"><?php echo e($groupedSettings->count()); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Main Settings Form -->
        <form method="POST" action="<?php echo e(route('admin.settings.images.update')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>

            <?php $__empty_1 = true; $__currentLoopData = $groupedSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group => $settings): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php if(isset($imageCategories[$group])): ?>
                    <div class="bg-white rounded-lg shadow-md mb-6 overflow-hidden">
                        <div class="category-header">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <i class="fas <?php echo e($imageCategories[$group]['icon']); ?> text-2xl mr-3"></i>
                                    <div>
                                        <h2 class="text-lg font-semibold"><?php echo e($imageCategories[$group]['title']); ?></h2>
                                        <p class="text-sm opacity-90"><?php echo e($imageCategories[$group]['description']); ?></p>
                                    </div>
                                </div>
                                <span class="bg-white bg-opacity-20 px-3 py-1 rounded-full text-sm">
                                    <?php echo e($settings->count()); ?> image(s)
                                </span>
                            </div>
                        </div>
                                ...
                                <?php $__currentLoopData = $settings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="image-upload-card border rounded-lg p-4 bg-white">
                                        <div class="flex justify-between items-start mb-3">
                                            <label class="font-medium text-gray-900"><?php echo e($setting->label ?? str_replace('_', ' ', $setting->key)); ?></label>
                                            <div class="sync-status" id="sync-status-<?php echo e($setting->key); ?>">
                                        ...
                                        <div class="image-preview-container rounded-lg mb-3">
                                            <?php if($setting->image_url): ?>
                                                <img src="<?php echo e($setting->image_url); ?>" alt="<?php echo e($setting->label); ?>" class="rounded-lg">
                                            <?php else: ?>
                                        ...
                                        <!-- File Input -->
                                        <input type="file"
                                               name="settings[<?php echo e($setting->key); ?>][file]"
                                               accept="image/*"
                                               class="w-full text-sm border rounded px-3 py-2"
                                               onchange="previewImage(this, '<?php echo e($setting->key); ?>')">
                                        <input type="hidden" name="settings[<?php echo e($setting->key); ?>][key]" value="<?php echo e($setting->key); ?>">

                                        <!-- Recommendations -->
                                        <?php if($setting->description): ?>
                                            <p class="text-xs text-gray-500 mt-2"><?php echo e($setting->description); ?></p>
                                        <?php endif; ?>

                                        <!-- Optimization Suggestions Container -->
                                        <div id="optimization-<?php echo e($setting->key); ?>" class="mt-2"></div>
                                    </div>
            ...
            <!-- Action Buttons -->
            <?php if($groupedSettings->count() > 0): ?>
...
function checkSyncStatus(key) {
    ...
    const checkUrl = '<?php echo e(route('admin.settings.image.optimization')); ?>';
...
function checkAllSyncStatus() {
    const keys = <?php echo json_encode($groupedSettings->flatten()->pluck('key'), 15, 512) ?>;
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\panchigallery.com\resources\views\admin\settings\images.blade.php ENDPATH**/ ?>