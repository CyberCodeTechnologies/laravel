...
<?php $__env->startSection('title', 'Theme & Appearance - Panchi Gallery'); ?>

<?php $__env->startSection('header', 'Theme & Appearance'); ?>
...
<div class="space-y-6">
    ...
    <form action="<?php echo e(route('admin.frontend.theme.update')); ?>" method="POST" class="space-y-6">
        <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-3">
                        <input type="color" name="theme[primary_color]" 
                               value="<?php echo e($themeSettings['primary_color']->value ?? $defaultColors['primary_color']); ?>"
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-3">
                        <input type="color" name="theme[secondary_color]" 
                               value="<?php echo e($themeSettings['secondary_color']->value ?? $defaultColors['secondary_color']); ?>"
                               class="w-12 h-12 rounded-lg border-2 border-gray-200 cursor-pointer">
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-3">
                        <input type="color" name="theme[accent_color]" 
                               value="<?php echo e($themeSettings['accent_color']->value ?? $defaultColors['accent_color']); ?>"
                               class="w-12 h-12 rounded-lg border-2 border-gray-200 cursor-pointer">
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-3">
                        <input type="color" name="theme[text_color]" 
                               value="<?php echo e($themeSettings['text_color']->value ?? $defaultColors['text_color']); ?>"
                               class="w-12 h-12 rounded-lg border-2 border-gray-200 cursor-pointer">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="theme[font_family]" class="w-full border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                        <option value="inter" <?php echo e(($themeSettings['font_family']->value ?? 'inter') == 'inter' ? 'selected' : ''); ?>>Inter (Modern Sans)</option>
                        <option value="playfair" <?php echo e(($themeSettings['font_family']->value ?? '') == 'playfair' ? 'selected' : ''); ?>>Playfair Display (Elegant Serif)</option>
                        <option value="roboto" <?php echo e(($themeSettings['font_family']->value ?? '') == 'roboto' ? 'selected' : ''); ?>>Roboto (Clean Sans)</option>
                    </select>
                ...
                <div>
                    ...
                    <select name="theme[border_radius]" class="w-full border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                        <option value="none" <?php echo e(($themeSettings['border_radius']->value ?? '') == 'none' ? 'selected' : ''); ?>>None (Sharp corners)</option>
                        <option value="sm" <?php echo e(($themeSettings['border_radius']->value ?? '') == 'sm' ? 'selected' : ''); ?>>Small (Subtle)</option>
                        <option value="md" <?php echo e(($themeSettings['border_radius']->value ?? 'md') == 'md' ? 'selected' : ''); ?>>Medium (Balanced)</option>
                        <option value="lg" <?php echo e(($themeSettings['border_radius']->value ?? '') == 'lg' ? 'selected' : ''); ?>>Large (Rounded)</option>
                        <option value="xl" <?php echo e(($themeSettings['border_radius']->value ?? '') == 'xl' ? 'selected' : ''); ?>>Extra Large (Very rounded)</option>
                    </select>
        ...
        <div class="flex justify-end space-x-4">
            <a href="<?php echo e(route('admin.frontend.dashboard')); ?>" class="btn-elegant px-6 py-3 rounded-lg">
                Cancel
            </a>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\panchigallery.com\resources\views\admin\frontend\theme.blade.php ENDPATH**/ ?>