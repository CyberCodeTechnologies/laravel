...
<?php $__env->startSection('meta-description', 'Edit FAQ for Panchi Gallery'); ?>

<?php $__env->startSection('header', 'Edit FAQ'); ?>
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-md">
        ...
        <form action="<?php echo e(route('admin.support.faq.update', $faq)); ?>" method="POST" class="p-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-8">
                ...
                <div class="mb-6">
                    ...
                    ><?php echo e(old('answer_en', $faq->answer_en)); ?></textarea>
                </div>
            </div>
            ...
            <div class="mb-8">
                ...
                <div class="mb-6">
                    ...
                    <input 
                        ...
                        id="question_my" 
                        name="question_my" 
                        value="<?php echo e(old('question_my', $faq->question_my)); ?>"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div class="mb-6">
                    ...
                    ><?php echo e(old('answer_my', $faq->answer_my)); ?></textarea>
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center">
                            <input 
                                ...
                                name="is_published" 
                                value="1"
                                <?php echo e(old('is_published', $faq->is_published) ? 'checked' : ''); ?>
            ...
            <div class="mb-8 p-4 bg-gray-50 rounded-lg">
                ...
                <div class="grid grid-cols-2 gap-4 text-sm">
                    <div>
                        ...
                        <span class="ml-2 text-gray-900">#<?php echo e($faq->id); ?></span>
                    </div>
                    <div>
                        <span class="text-gray-500">Created:</span>
                        <span class="ml-2 text-gray-900"><?php echo e($faq->created_at->format('M j, Y g:i A')); ?></span>
                    </div>
                    <div>
                        <span class="text-gray-500">Updated:</span>
                        <span class="ml-2 text-gray-900"><?php echo e($faq->updated_at->format('M j, Y g:i A')); ?></span>
                    </div>
                    <div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\panchigallery.com\resources\views\admin\support\faq\edit.blade.php ENDPATH**/ ?>