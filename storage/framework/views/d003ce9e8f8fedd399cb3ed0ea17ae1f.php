<?php $__env->startSection('title', 'Create Resale Listing - Panchi Gallery'); ?>
<?php $__env->startSection('meta-description', 'List your artwork for resale on the secondary market.'); ?>
...
<section class="bg-gray-900 text-white py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p class="text-gray-300">List "<?php echo e($artwork->title); ?>" for resale</p>
    </div>
</section>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-lg shadow-sm p-8">
            ...
            <div class="flex gap-4 mb-8 p-4 bg-gray-50 rounded-lg">
                ...
                <div>
                    <h3 class="font-serif font-bold"><?php echo e($artwork->title); ?></h3>
                    <p class="text-gray-600 text-sm">by <?php echo e($artwork->artist->name ?? 'Unknown'); ?></p>
                    <p class="text-gray-500 text-sm mt-1">Original Price: $<?php echo e(number_format($artwork->original_price ?? $artwork->price, 2)); ?></p>
                </div>
            </div>

            <form action="<?php echo e(route('collector.resales.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1">Platform fee: <?php echo e(\App\Models\Transaction::getPlatformFeePercentage()); ?>% of sale price</p>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <?php $__errorArgs = ['condition_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <label for="terms" class="text-sm text-gray-600">
                            ...
                            and <a href="<?php echo e(route('privacy')); ?>" class="text-blue-600 hover:underline" target="_blank">Privacy Policy</a>.
                        </label>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\panchigallery.com\resources\views\collector\resales-create.blade.php ENDPATH**/ ?>