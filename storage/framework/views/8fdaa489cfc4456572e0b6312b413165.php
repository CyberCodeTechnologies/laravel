...
<?php $__env->startSection('title', 'Frontend Management - Panchi Gallery'); ?>

<?php $__env->startSection('header', 'Frontend Management'); ?>
...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="card-luxury rounded-xl p-6 hover:shadow-lg transition-shadow">
            <div class="flex items-center mb-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500"><?php echo e(count($homepageSections)); ?> sections</p>
                </div>
            </div>
            <p class="text-gray-600 text-sm mb-4">Manage hero, featured, about, artists, testimonials, and CTA sections</p>
            <a href="<?php echo e(route('admin.frontend.homepage')); ?>" class="btn-luxury w-full py-2 rounded-lg text-white text-sm font-medium block text-center">
                Manage Homepage
            </a>
        </div>
        ...
        <div class="card-luxury rounded-xl p-6 hover:shadow-lg transition-shadow">
            ...
            <a href="<?php echo e(route('admin.frontend.navigation')); ?>" class="btn-luxury w-full py-2 rounded-lg text-white text-sm font-medium block text-center">
                Manage Navigation
            </a>
        </div>
        ...
        <div class="card-luxury rounded-xl p-6 hover:shadow-lg transition-shadow">
            <div class="flex items-center mb-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500"><?php echo e($footerSettings->count()); ?> settings</p>
                </div>
            </div>
            <p class="text-gray-600 text-sm mb-4">Manage footer columns, links, copyright, and bottom section</p>
            <a href="<?php echo e(route('admin.frontend.footer')); ?>" class="btn-luxury w-full py-2 rounded-lg text-white text-sm font-medium block text-center">
                Manage Footer
            </a>
        </div>
        ...
        <div class="card-luxury rounded-xl p-6 hover:shadow-lg transition-shadow">
            <div class="flex items-center mb-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500"><?php echo e($themeSettings->count()); ?> settings</p>
                </div>
            </div>
            <p class="text-gray-600 text-sm mb-4">Customize colors, fonts, border radius, and visual elements</p>
            <a href="<?php echo e(route('admin.frontend.theme')); ?>" class="btn-luxury w-full py-2 rounded-lg text-white text-sm font-medium block text-center">
                Customize Theme
            </a>
        </div>
        ...
        <div class="card-luxury rounded-xl p-6 hover:shadow-lg transition-shadow">
            <div class="flex items-center mb-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500"><?php echo e($seoSettings->count()); ?> settings</p>
                </div>
            </div>
            <p class="text-gray-600 text-sm mb-4">Meta tags, Open Graph, analytics, and search engine optimization</p>
            <a href="<?php echo e(route('admin.frontend.seo')); ?>" class="btn-luxury w-full py-2 rounded-lg text-white text-sm font-medium block text-center">
                Manage SEO
            </a>
        </div>
        ...
        <div class="card-luxury rounded-xl p-6 hover:shadow-lg transition-shadow">
            <div class="flex items-center mb-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500"><?php echo e($socialSettings->count()); ?> links</p>
                </div>
            </div>
            <p class="text-gray-600 text-sm mb-4">Manage social media links for Facebook, Instagram, Twitter, and more</p>
            <a href="<?php echo e(route('admin.frontend.social')); ?>" class="btn-luxury w-full py-2 rounded-lg text-white text-sm font-medium block text-center">
                Manage Social
            </a>
        </div>
        ...
        <div class="card-luxury rounded-xl p-6 hover:shadow-lg transition-shadow">
            ...
            <a href="<?php echo e(route('admin.frontend.contact')); ?>" class="btn-luxury w-full py-2 rounded-lg text-white text-sm font-medium block text-center">
                Manage Contact
            </a>
        </div>
        ...
        <div class="card-luxury rounded-xl p-6 hover:shadow-lg transition-shadow">
            ...
            <a href="<?php echo e(route('admin.frontend.announcements')); ?>" class="btn-luxury w-full py-2 rounded-lg text-white text-sm font-medium block text-center">
    ...
    <div class="bg-gray-50 rounded-xl p-6">
        ...
        <div class="flex flex-wrap gap-3">
            <a href="<?php echo e(route('admin.settings.general')); ?>" class="btn-elegant px-4 py-2 rounded-lg text-sm">
                General Settings
            </a>
            <a href="<?php echo e(route('admin.settings.images')); ?>" class="btn-elegant px-4 py-2 rounded-lg text-sm">
                Image Settings
            </a>
            <a href="<?php echo e(route('admin.page-contents.index')); ?>" class="btn-elegant px-4 py-2 rounded-lg text-sm">
                Page Contents
            </a>
            <a href="<?php echo e(route('admin.settings.language')); ?>" class="btn-elegant px-4 py-2 rounded-lg text-sm">
                Language Settings
            </a>
        </div>
    </div>
...
<script>
    ...
    function updateCacheStatus() {
        fetch('<?php echo e(route("admin.settings.cache")); ?>')
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\panchigallery.com\resources\views\admin\frontend\dashboard.blade.php ENDPATH**/ ?>