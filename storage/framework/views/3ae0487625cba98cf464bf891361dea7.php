<?php $__env->startSection('title', 'Purchase History - Panchi Gallery'); ?>
<?php $__env->startSection('meta-description', 'View your complete purchase history and transaction details.'); ?>
                            ...
                            <tr>
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="font-medium"><?php echo e($transaction->artwork->title); ?></span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-sm text-gray-600">
                                    <?php echo e($transaction->artwork->artist->name ?? 'Unknown'); ?>
                                ...
                                <td class="px-6 py-4">
                                    <a href="<?php echo e(route('orders.show', $transaction)); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\panchigallery.com\resources\views\collector\purchases.blade.php ENDPATH**/ ?>