<?php $__env->startSection('title', __('messages.artworks') . ' - Panchi Gallery'); ?>
<?php $__env->startSection('meta-description', __('messages.artworks_meta_description')); ?>
<?php $__env->startSection('meta-keywords', 'Myanmar art, artwork for sale, original paintings, contemporary art, traditional art, art gallery, buy art online, Panchi Gallery'); ?>
...
<script type="application/ld+json">
{
    ...
    "@type": "CollectionPage",
    "name": "<?php echo e(__('messages.artworks')); ?>",
    "description": "<?php echo e(__('messages.artworks_meta_description')); ?>",
    "url": "<?php echo e(route('public.artworks.index')); ?>",
    "numberOfItems": <?php echo e($artworks->count() ?? 0); ?>,
    "itemListElement": [
        <?php $__currentLoopData = $artworks->take(20); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $artwork): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        {
            "@type": "ListItem",
            "position": <?php echo e($index + 1); ?>,
            "item": {
                "@type": "Product",
                "name": "<?php echo e($artwork->title); ?>",
                "url": "<?php echo e(route('public.artworks.show', $artwork->slug)); ?>",
                "image": "<?php echo e($artwork->primary_image ?? asset('images/placeholder-artwork.jpg')); ?>",
                "offers": {
                    "@type": "Offer",
                    "price": "<?php echo e($artwork->price); ?>",
                    "priceCurrency": "<?php echo e($artwork->currency ?? 'USD'); ?>",
                    "availability": "<?php echo e($artwork->isAvailable() ? 'https://schema.org/InStock' : 'https://schema.org/SoldOut'); ?>"
                }
            }
        }<?php if($index < $artworks->count() - 1 && $index < 19): ?>,<?php endif; ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center">
            ...
            <div class="inline-flex items-center space-x-2 bg-black/5 backdrop-blur-md px-6 py-2 rounded-full mb-8 border border-black/10">
                ...
                <span class="text-black/80 text-sm font-medium"><?php echo e($artworks->count() ?? 0); ?> <?php echo e(__('messages.unique_artworks')); ?></span>
            </div>
            
            <h1 class="font-serif text-6xl md:text-7xl lg:text-8xl font-bold text-gray-900 mb-6 tracking-tight leading-tight">
                <?php echo __('messages.discover_exceptional_art'); ?>

            </h1>
            <p class="text-xl text-gray-600 max-w-2xl mx-auto mb-12 leading-relaxed">
                <?php echo e(__('messages.artworks_description')); ?>
                ...
                <div class="relative group">
                    ...
                    <div class="relative">
                        <input 
                            ...
                            placeholder="<?php echo e(__('messages.search_artworks_placeholder')); ?>"
            ...
            <div class="flex flex-wrap justify-center gap-8 mt-12">
                <div class="text-center">
                    <div class="text-4xl md:text-5xl font-bold text-gray-900 mb-1"><?php echo e($artworks->count() ?? 0); ?>+</div>
                    <div class="text-gray-600 text-sm font-medium"><?php echo e(__('messages.artworks')); ?></div>
                </div>
                <div class="text-center">
                    <div class="text-4xl md:text-5xl font-bold text-gray-900 mb-1"><?php echo e($artists_count ?? 50); ?>+</div>
                    <div class="text-gray-600 text-sm font-medium"><?php echo e(__('messages.artists')); ?></div>
                </div>
                <div class="text-center">
                    <div class="text-4xl md:text-5xl font-bold text-gray-900 mb-1"><?php echo e($categories_count ?? 12); ?>+</div>
                    <div class="text-gray-600 text-sm font-medium"><?php echo e(__('messages.category')); ?></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="flex flex-col md:flex-row items-center justify-between mb-12 gap-6">
            <div>
                ...
                <p class="text-gray-600 text-lg"><?php echo e(__('messages.browse_collection_subtitle')); ?></p>
            </div>
                    ...
                    <div class="relative">
                        <select name="sort" onchange="document.getElementById('sortForm').submit()" class="appearance-none px-6 py-3 bg-white border border-gray-200 rounded-xl text-gray-900 focus:outline-none focus:border-black focus:ring-2 focus:ring-black/10 transition-all duration-300 cursor-pointer pr-10 shadow-sm">
                            <?php $__currentLoopData = $sortOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>" <?php echo e(request('sort') == $key ? 'selected' : ''); ?>><?php echo e($option); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
        ...
        <div class="main-content-area flex flex-col lg:flex-row gap-8">
            ...
            <aside class="filter-sidebar lg:w-72 flex-shrink-0">
                <form id="filterForm" method="GET" class="bg-white rounded-xl border border-gray-200 shadow-lg p-6 sticky top-24">
                    <div class="flex items-center justify-between mb-6">
                        <h2 class="font-semibold text-lg text-gray-900"><?php echo e(__('messages.filter')); ?></h2>
                        <button type="button" onclick="clearFilters()" class="text-sm text-gray-600 hover:text-gray-900 transition-colors"><?php echo e(__('messages.clear_all')); ?></button>
                    </div>
                    
                    <!-- Search -->
                    <div class="mb-6">
                        <label class="block text-sm font-medium text-gray-800 mb-2"><?php echo e(__('messages.search')); ?></label>
                        <div class="relative">
                            <input 
                                type="text" 
                                name="search"
                                value="<?php echo e(request('search')); ?>"
                                placeholder="<?php echo e(__('messages.search_artworks')); ?>"
                    ...
                    <!-- Categories -->
                    <div class="mb-6">
                        <h3 class="font-medium text-gray-900 mb-3"><?php echo e(__('messages.category')); ?></h3>
                        <div class="space-y-2">
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="flex items-center group cursor-pointer">
                                <input type="checkbox" class="rounded border-gray-300 bg-white text-black focus:ring-black focus:ring-offset-0" name="category[]" value="<?php echo e($category->id); ?>" <?php echo e(is_array(request('category')) && in_array($category->id, request('category')) ? 'checked' : (request('category') == $category->id ? 'checked' : '')); ?> onchange="applyFilters()">
                                <span class="ml-2 text-sm text-gray-800 group-hover:text-gray-900 transition-colors"><?php echo e($category->name); ?></span>
                                <span class="ml-auto text-xs text-gray-400">(<?php echo e($category->artworks_count); ?>)</span>
                            </label>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                    ...
                    <!-- Price Range -->
                    <div class="mb-6">
                        <h3 class="font-medium text-gray-900 mb-3"><?php echo e(__('messages.price_range')); ?></h3>
                        <div class="space-y-3">
                            <div class="flex items-center space-x-2">
                                <input type="number" name="min_price" value="<?php echo e(request('min_price')); ?>" placeholder="<?php echo e(__('messages.min')); ?>" class="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-black focus:ring-2 focus:ring-black/10 transition-all duration-300 text-gray-900 placeholder-gray-400">
                                <span class="text-gray-500">-</span>
                                <input type="number" name="max_price" value="<?php echo e(request('max_price')); ?>" placeholder="<?php echo e(__('messages.max')); ?>" class="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-black focus:ring-2 focus:ring-black/10 transition-all duration-300 text-gray-900 placeholder-gray-400">
                            </div>
                            <div class="flex flex-wrap gap-2">
                                <button type="button" onclick="setPriceRange(0, 500)" class="px-3 py-1.5 bg-gray-100 text-gray-800 rounded-full text-sm hover:bg-gray-200 transition-colors border border-gray-200 <?php echo e(request('min_price') == 0 && request('max_price') == 500 ? 'bg-black text-white border-black' : ''); ?>">
                                    <?php echo e(__('messages.under_price', ['price' => '$500'])); ?>

                                </button>
                                <button type="button" onclick="setPriceRange(500, 1000)" class="px-3 py-1.5 bg-gray-100 text-gray-800 rounded-full text-sm hover:bg-gray-200 transition-colors border border-gray-200 <?php echo e(request('min_price') == 500 && request('max_price') == 1000 ? 'bg-black text-white border-black' : ''); ?>">
                                    $500 - $1,000
                                </button>
                                <button type="button" onclick="setPriceRange(1000, 2000)" class="px-3 py-1.5 bg-gray-100 text-gray-800 rounded-full text-sm hover:bg-gray-200 transition-colors border border-gray-200 <?php echo e(request('min_price') == 1000 && request('max_price') == 2000 ? 'bg-black text-white border-black' : ''); ?>">
                                    $1,000 - $2,000
                                </button>
                                <button type="button" onclick="setPriceRange(2000, 5000)" class="px-3 py-1.5 bg-gray-100 text-gray-800 rounded-full text-sm hover:bg-gray-200 transition-colors border border-gray-200 <?php echo e(request('min_price') == 2000 && request('max_price') == 5000 ? 'bg-black text-white border-black' : ''); ?>">
                                    $2,000 - $5,000
                                </button>
                                <button type="button" onclick="setPriceRange(5000, null)" class="px-3 py-1.5 bg-gray-100 text-gray-800 rounded-full text-sm hover:bg-gray-200 transition-colors border border-gray-200 <?php echo e(request('min_price') == 5000 && !request('max_price') ? 'bg-black text-white border-black' : ''); ?>">
                                    Over $5,000
                                </button>
                            </div>
                        </div>
                    ...
                    <!-- Medium -->
                    <div class="mb-6">
                        <h3 class="font-medium text-gray-900 mb-3"><?php echo e(__('messages.medium')); ?></h3>
                        <div class="space-y-2">
                            ...
                            <label class="flex items-center group cursor-pointer">
                                <input type="checkbox" class="rounded border-gray-300 bg-white text-black focus:ring-black focus:ring-offset-0" name="medium[]" value="<?php echo e($key); ?>" <?php echo e(is_array(request('medium')) && in_array($key, request('medium')) ? 'checked' : (request('medium') == $key ? 'checked' : '')); ?> onchange="applyFilters()">
                                <span class="ml-2 text-sm text-gray-800 group-hover:text-gray-900 transition-colors"><?php echo e($medium); ?></span>
                            </label>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                    ...
                    <!-- Artist -->
                    <div class="mb-6">
                        <h3 class="font-medium text-gray-900 mb-3"><?php echo e(__('messages.artist')); ?></h3>
                        <select name="artist" onchange="applyFilters()" class="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-black focus:ring-2 focus:ring-black/10 transition-all duration-300 text-gray-900">
                            <option value=""><?php echo e(__('messages.all_artists')); ?></option>
                            <?php $__currentLoopData = $artists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $artist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($artist->id); ?>" <?php echo e(request('artist') == $artist->id ? 'selected' : ''); ?>><?php echo e($artist->name); ?> (<?php echo e($artist->artworks_count); ?>)</option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    ...
                    <!-- Size -->
                    <div class="mb-6">
                        <h3 class="font-medium text-gray-900 mb-3"><?php echo e(__('messages.size')); ?></h3>
                        <div class="space-y-2">
                            ...
                            <label class="flex items-center group cursor-pointer">
                                <input type="checkbox" class="rounded border-gray-300 bg-white text-black focus:ring-black focus:ring-offset-0" name="size[]" value="<?php echo e($key); ?>" <?php echo e(is_array(request('size')) && in_array($key, request('size')) ? 'checked' : (request('size') == $key ? 'checked' : '')); ?> onchange="applyFilters()">
                                <span class="ml-2 text-sm text-gray-800 group-hover:text-gray-900 transition-colors"><?php echo e($size); ?></span>
                            </label>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                    ...
                    <button type="submit" class="w-full py-3 bg-black text-white font-medium rounded-xl hover:bg-gray-800 transition-all duration-300 shadow-lg hover:shadow-xl">
                        <?php echo e(__('messages.apply_filters')); ?>
            ...
            <div class="flex-1">
                ...
                <div class="mb-6 flex flex-wrap items-center gap-3" id="activeFilters">
                    <span class="text-sm text-gray-600"><?php echo e(__('messages.active_filters')); ?></span>
                    <?php if(request('category')): ?>
                        <?php $requestedCategories = is_array(request('category')) ? request('category') : [request('category')]; ?>
                        <?php $__currentLoopData = $requestedCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $catId): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="inline-flex items-center px-4 py-2 rounded-full text-sm bg-gray-100 border border-gray-200 text-gray-900">
                                <?php echo e($categories->find($catId)->name ?? $catId); ?>

                                <button onclick="removeFilterValue('category', '<?php echo e($catId); ?>')" class="ml-2 hover:text-gray-600 transition-colors" aria-label="Remove filter">
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                    <?php if(request('medium')): ?>
                        <?php $requestedMediums = is_array(request('medium')) ? request('medium') : [request('medium')]; ?>
                        <?php $__currentLoopData = $requestedMediums; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $medKey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="inline-flex items-center px-4 py-2 rounded-full text-sm bg-gray-100 border border-gray-200 text-gray-900">
                                <?php echo e($mediums[$medKey] ?? $medKey); ?>

                                <button onclick="removeFilterValue('medium', '<?php echo e($medKey); ?>')" class="ml-2 hover:text-gray-600 transition-colors" aria-label="Remove filter">
                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                                    </svg>
                                </button>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                    <?php if(request('artist')): ?>
                        <span class="inline-flex items-center px-4 py-2 rounded-full text-sm bg-gray-100 border border-gray-200 text-gray-900">
                            <?php echo e($artists->find(request('artist'))->name ?? request('artist')); ?>
                    ...
                    <?php endif; ?>
                    <?php if(request('size')): ?>
                        <?php $requestedSizes = is_array(request('size')) ? request('size') : [request('size')]; ?>
                        <?php $__currentLoopData = $requestedSizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sizeKey): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="inline-flex items-center px-4 py-2 rounded-full text-sm bg-gray-100 border border-gray-200 text-gray-900">
                                <?php echo e($sizes[$sizeKey] ?? $sizeKey); ?>

                                <button onclick="removeFilterValue('size', '<?php echo e($sizeKey); ?>')" class="ml-2 hover:text-gray-600 transition-colors" aria-label="Remove filter">
                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                                    </svg>
                                </button>
                    ...
                    <?php endif; ?>
                    <span class="text-sm text-gray-500"><?php echo e($artworks->count() ?? 0); ?> results</span>
                </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.artwork-card','data' => ['artwork' => $artwork,'showArtist' => true,'showPrice' => true,'showWishlist' => true,'compact' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['artwork' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($artwork),'show-artist' => true,'show-price' => true,'show-wishlist' => true,'compact' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
...
<?php endif; ?>
                    ...
                    <?php else: ?>
                        <div class="col-span-full text-center py-16">
                            <div class="bg-white rounded-2xl p-12 border border-gray-200 shadow-lg">
                                ...
                                <p class="text-gray-600 text-lg"><?php echo e(__('messages.no_artworks_found')); ?></p>
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="mt-12 flex flex-col sm:flex-row items-center justify-between gap-4">
                    <p class="text-sm text-gray-600">
                        <?php echo e(__('messages.showing_results', ['first' => $artworks->firstItem(), 'last' => $artworks->lastItem(), 'total' => $artworks->total()])); ?>

                    </p>
                    <div class="flex items-center space-x-2">
                        <?php echo e($artworks->links('pagination::tailwind')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\panchigallery.com\resources\views\artworks\index.blade.php ENDPATH**/ ?>