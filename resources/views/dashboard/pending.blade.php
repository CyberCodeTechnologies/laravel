...
@section('title', 'Pending Approval - Panchi Gallery')
...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white rounded-lg shadow-sm p-12 text-center">
            ...
            <a href="{{ route('home') }}" class="bg-black text-white px-8 py-3 rounded-lg hover:bg-gray-800 transition inline-block">
                Return to Home
            </a>
        </div>
    </div>
