    ...
    <div class="flex min-h-full items-center justify-center p-4">
        ...
        <div class="relative bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden shadow-2xl transform transition-all">
            ...
            <div class="flex items-center justify-between p-6 border-b border-gray-200">
                <h3 class="text-2xl font-bold text-gray-900" id="modal-artwork-title">{{ __('messages.artwork_details_title') }}</h3>
                <button type="button" 
                ...
                <div class="lg:w-1/2 p-6 space-y-6">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-lg text-gray-600">
                            {{ __('messages.by_artist') }} <span class="font-medium" id="modal-artwork-artist"></span>
                        </p>
                    </div>
                    ...
                    <div class="flex items-center justify-between mb-6 p-4 bg-gray-50 rounded-lg">
                        <div>
                            <p class="text-sm text-gray-600 mb-1">{{ __('messages.price') }}</p>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between py-3 border-b border-gray-200" id="modal-artwork-medium-row">
                            <span class="text-sm font-medium text-gray-700">{{ __('messages.medium') }}</span>
                        ...
                        <div class="flex items-center justify-between py-3 border-b border-gray-200" id="modal-artwork-size-row">
                            <span class="text-sm font-medium text-gray-700">{{ __('messages.dimensions') }}</span>
                        ...
                        <div class="flex items-center justify-between py-3 border-b border-gray-200" id="modal-artwork-year-row">
                            <span class="text-sm font-medium text-gray-700">{{ __('messages.year_created') }}</span>
