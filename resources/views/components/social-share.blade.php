...
<div class="social-share-buttons flex flex-wrap gap-2">
    <!-- Facebook -->
    <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode($url) }}&title={{ urlencode($title) }}&description={{ urlencode($description) }}"
       target="_blank"
    ...
    <!-- Messenger -->
    <a href="https://www.facebook.com/dialog/send?link={{ urlencode($url) }}&app_id={{ config('services.facebook.app_id') }}"
       target="_blank"
       rel="noopener noreferrer"
    ...
    <!-- Viber -->
    <a href="viber://forward?text={{ urlencode($title . ' ' . $url) }}"
