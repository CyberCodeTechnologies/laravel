...
@section('title', 'Complete Purchase - Panchi Gallery')
@section('meta-description', 'Complete your artwork purchase securely.')
        ...
        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
            ...
            <div class="p-6 border-b">
                <div class="flex gap-4">
                    ...
                    <div class="flex-1">
                        <h2 class="font-serif text-xl font-bold mb-1">{{ $artwork->title }}</h2>
                        <p class="text-gray-600 mb-2">by {{ $artwork->artist->name ?? 'Unknown' }}</p>
                        <p class="text-gray-500 text-sm">{{ $artwork->dimensions }} | {{ $artwork->medium }}</p>
                        <p class="text-2xl font-bold mt-3">${{ number_format($artwork->price, 2) }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6 bg-gray-50 border-b">
                ...
                <div class="space-y-2 text-sm">
                    <div class="flex justify-between">
                        ...
                        <span>${{ number_format($artwork->price, 2) }}</span>
                    </div>
                    <div class="flex justify-between">
                    ...
                    <div class="border-t pt-2 mt-2">
                        <div class="flex justify-between font-semibold text-base">
                            <span>Total</span>
                            <span>${{ number_format($artwork->price + $platformFee, 2) }}</span>
                        </div>
                    </div>
                </div>
            </div>
