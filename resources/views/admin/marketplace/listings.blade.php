...
@section('title', 'Marketplace Listings - Admin')
@section('meta-description', 'Manage active marketplace listings on Panchi Gallery')

@section('header', 'Marketplace Listings')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <form method="GET" class="flex flex-wrap gap-3 items-center">
                ...
                <a href="{{ route('admin.marketplace.listings') }}" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-300 transition">
