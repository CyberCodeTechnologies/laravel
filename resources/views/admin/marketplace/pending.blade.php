...
@section('title', 'Pending Marketplace Listings - Admin')
@section('meta-description', 'Review and approve pending resale listings on Panchi Gallery')

@section('header', 'Pending Marketplace Listings')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <form method="GET" class="flex flex-wrap gap-3 items-center">
                ...
                <a href="{{ route('admin.marketplace.pending') }}" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-300 transition">
            ...
            <div class="flex gap-3">
                ...
                <a href="{{ route('admin.marketplace.listings') }}" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition">
                        ...
                        @forelse($resales as $resale)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    {{ $resale->created_at->format('M d, Y H:i') }}
                                </td>
