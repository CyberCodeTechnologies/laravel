...
@section('meta-description', 'Configure payment settings on Panchi Gallery')
            ...
            <div class="bg-yellow-50 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-yellow-900">{{ App\Models\PaymentMethod::count() }}</p>
            ...
            <div class="bg-green-50 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-green-900">{{ App\Models\Transaction::count() }}</p>
            ...
            <div class="bg-blue-50 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-blue-900">{{ $platformFee }}%</p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                <form method="POST" action="{{ route('admin.settings.payment.update') }}" class="bg-white rounded-lg shadow-md mb-6">
                    @csrf
                    <div class="p-6">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <input type="number" id="platform_fee" name="platform_fee" value="{{ $platformFee }}" step="0.1" min="0" max="100"
                            ...
                            <div>
                                ...
                                <div class="space-y-2">
                                    <label class="flex items-center p-3 border border-gray-300 rounded-lg hover:bg-gray-50 cursor-pointer">
                                        <input type="checkbox" name="payment_gateways[]" value="stripe" {{ in_array('stripe', $paymentGateways) ? 'checked' : '' }}
                                    ...
                                    <label class="flex items-center p-3 border border-gray-300 rounded-lg hover:bg-gray-50 cursor-pointer">
                                        <input type="checkbox" name="payment_gateways[]" value="paypal" {{ in_array('paypal', $paymentGateways) ? 'checked' : '' }}
                                               class="h-4 w-4 text-yellow-600 focus:ring-yellow-500 border-gray-300 rounded">
                                        <div class="ml-3">
                                    ...
                                    <label class="flex items-center p-3 border border-gray-300 rounded-lg hover:bg-gray-50 cursor-pointer">
                                        <input type="checkbox" name="payment_gateways[]" value="kbzpay" {{ in_array('kbzpay', $paymentGateways) ? 'checked' : '' }}
                                               class="h-4 w-4 text-yellow-600 focus:ring-yellow-500 border-gray-300 rounded">
                                        <div class="ml-3">
                                    ...
                                    <label class="flex items-center p-3 border border-gray-300 rounded-lg hover:bg-gray-50 cursor-pointer">
                                        <input type="checkbox" name="payment_gateways[]" value="wavepay" {{ in_array('wavepay', $paymentGateways) ? 'checked' : '' }}
                                               class="h-4 w-4 text-yellow-600 focus:ring-yellow-500 border-gray-300 rounded">
                                        <div class="ml-3">
                            ...
                            <div>
                                <label class="flex items-center">
                                    <input type="checkbox" name="auto_approve_payments" value="1" {{ $autoApprovePayments ? 'checked' : '' }}
                                           class="h-4 w-4 text-yellow-600 focus:ring-yellow-500 border-gray-300 rounded">
                                    <div class="ml-3">
            ...
            <div class="space-y-6">
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between">
                            ...
                            <span class="text-sm font-medium text-gray-900">{{ App\Models\Transaction::where('status', 'pending')->count() }}</span>
                        </div>
                        <div class="flex justify-between">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="space-y-3">
                        <a href="{{ route('admin.payments.verifications') }}" class="flex items-center p-3 bg-blue-50 rounded-lg hover:bg-blue-100 transition">
                            <i class="fas fa-check-double text-blue-600 mr-3"></i>
                            <span class="text-sm font-medium text-gray-900">Verify Payments</span>
                        </a>
                        <a href="{{ route('admin.transactions') }}" class="flex items-center p-3 bg-green-50 rounded-lg hover:bg-green-100 transition">
