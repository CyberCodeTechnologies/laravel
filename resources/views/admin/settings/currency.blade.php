...
@section('title', 'Currency Settings - Admin')
@section('meta-description', 'Configure currency settings on Panchi Gallery')
            ...
            <div class="bg-green-50 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-green-900">{{ config('currency.default', 'USD') }}</p>
            ...
            <div class="bg-blue-50 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-blue-900">{{ count(json_decode($enabledCurrencies ?? '[]', true) ?: config('currency.supported', [])) }}</p>
            ...
            <div class="bg-yellow-50 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-yellow-900">{{ number_format($exchangeRateMMK ?? config('currency.exchange_rates.MMK', 4400), 0) }}</p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                <form method="POST" action="{{ route('admin.settings.currency.update') }}" class="bg-white rounded-lg shadow-md">
                    @csrf
                    <div class="p-6">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <select id="default_currency" name="default_currency" required
                                    ...
                                    <option value="USD" {{ ($defaultCurrency ?? config('currency.default', 'USD')) === 'USD' ? 'selected' : '' }}>USD - US Dollar</option>
                                    <option value="MMK" {{ ($defaultCurrency ?? config('currency.default', 'USD')) === 'MMK' ? 'selected' : '' }}>MMK - Myanmar Kyat</option>
                                    <option value="EUR" {{ ($defaultCurrency ?? config('currency.default', 'USD')) === 'EUR' ? 'selected' : '' }}>EUR - Euro</option>
                                    <option value="GBP" {{ ($defaultCurrency ?? config('currency.default', 'USD')) === 'GBP' ? 'selected' : '' }}>GBP - British Pound</option>
                                </select>
                            ...
                            <div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <label class="flex items-center p-3 border border-gray-300 rounded-lg hover:bg-gray-50 cursor-pointer">
                                        <input type="checkbox" name="enabled_currencies[]" value="USD" {{ in_array('USD', $enabledCurrenciesArray) ? 'checked' : '' }}
                                    ...
                                    <label class="flex items-center p-3 border border-gray-300 rounded-lg hover:bg-gray-50 cursor-pointer">
                                        <input type="checkbox" name="enabled_currencies[]" value="MMK" {{ in_array('MMK', $enabledCurrenciesArray) ? 'checked' : '' }}
                                               class="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded">
                                        <div class="ml-3">
                                    ...
                                    <label class="flex items-center p-3 border border-gray-300 rounded-lg hover:bg-gray-50 cursor-pointer">
                                        <input type="checkbox" name="enabled_currencies[]" value="EUR" {{ in_array('EUR', $enabledCurrenciesArray) ? 'checked' : '' }}
                                               class="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded">
                                        <div class="ml-3">
                                    ...
                                    <label class="flex items-center p-3 border border-gray-300 rounded-lg hover:bg-gray-50 cursor-pointer">
                                        <input type="checkbox" name="enabled_currencies[]" value="GBP" {{ in_array('GBP', $enabledCurrenciesArray) ? 'checked' : '' }}
                                               class="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded">
                                        <div class="ml-3">
                            ...
                            <div>
                                ...
                                <input type="number" id="exchange_rate" name="exchange_rate"
                                       value="{{ $exchangeRateMMK ?? config('currency.exchange_rates.MMK', 4400) }}" step="0.01" min="0"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between">
                            ...
                            <span class="text-sm font-medium text-gray-900">{{ session('currency', 'USD') }}</span>
                        </div>
                        <div class="flex justify-between">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="{{ route('admin.settings.cache') }}" class="flex items-center p-3 bg-blue-50 rounded-lg hover:bg-blue-100 transition">
