...
@section('meta-description', 'View system logs on Panchi Gallery')
            ...
            <div class="bg-red-50 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-red-900">{{ file_exists(storage_path('logs/laravel.log')) ? 'Active' : 'None' }}</p>
            ...
            <div class="bg-blue-50 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-blue-900">{{ file_exists(storage_path('logs/laravel.log')) ? number_format(filesize(storage_path('logs/laravel.log')) / 1024, 2) : '0' }} KB</p>
            ...
            <div class="bg-green-50 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-xs text-green-700 mt-1">{{ config('app.log_level', 'debug') }}</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="text-sm font-medium text-gray-900">{{ file_exists(storage_path('logs/laravel.log')) ? now()->diffInSeconds(\Carbon\Carbon::createFromTimestamp(filemtime(storage_path('logs/laravel.log')))) . 's ago' : 'Never' }}</span>
                        </div>
                        <div class="flex justify-between">
