...
@section('meta-description', 'Configure platform-wide settings and preferences on Panchi Gallery')
            ...
            <div class="bg-blue-50 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-xs text-blue-700 mt-1">{{ config('app.env') }} environment</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-green-50 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-green-900">{{ App\Models\User::count() }}</p>
            ...
            <div class="bg-purple-50 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-purple-900">{{ App\Models\Artwork::count() }}</p>
            ...
            <div class="bg-yellow-50 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-yellow-900">${{ number_format(App\Models\Transaction::where('status', 'completed')->sum('amount'), 0) }}</p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                <!-- Site Settings -->
                <form method="POST" action="{{ route('admin.settings.site') }}" class="bg-white rounded-lg shadow-md mb-6">
                    @csrf
                    @method('PUT')
                    <div class="p-6">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <input type="text" id="site_name" name="site_name" value="{{ \App\Models\GeneralSetting::getValue('site_name', config('app.name')) }}" required
                            ...
                            <div>
                                ...
                                <textarea id="site_description" name="site_description" rows="3"
                                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ \App\Models\GeneralSetting::getValue('site_description') }}</textarea>
                            </div>
                            
                            <div>
                                <label for="site_keywords" class="block text-sm font-medium text-gray-700 mb-1">SEO Keywords</label>
                                <input type="text" id="site_keywords" name="site_keywords" value="{{ \App\Models\GeneralSetting::getValue('site_keywords') }}"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="email" id="contact_email" name="contact_email" value="{{ \App\Models\GeneralSetting::getValue('contact_email', config('mail.from.address')) }}" required
                                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                </div>
                                <div>
                                    <label for="contact_phone" class="block text-sm font-medium text-gray-700 mb-1">Contact Phone</label>
                                    <input type="tel" id="contact_phone" name="contact_phone" value="{{ \App\Models\GeneralSetting::getValue('contact_phone') }}"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea id="address" name="address" rows="2"
                                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ \App\Models\GeneralSetting::getValue('address') }}</textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-lg shadow-md">
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <a href="{{ route('admin.settings.language') }}" class="flex items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition">
                                <div class="p-3 bg-blue-100 rounded-full">
                            ...
                            <a href="{{ route('admin.settings.currency') }}" class="flex items-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition">
                                <div class="p-3 bg-green-100 rounded-full">
                            ...
                            <a href="{{ route('admin.settings.email') }}" class="flex items-center p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition">
                                <div class="p-3 bg-purple-100 rounded-full">
                            ...
                            <a href="{{ route('admin.settings.payment') }}" class="flex items-center p-4 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition">
                                <div class="p-3 bg-yellow-100 rounded-full">
                            ...
                            <a href="{{ route('admin.settings.shipping') }}" class="flex items-center p-4 bg-orange-50 rounded-lg hover:bg-orange-100 transition">
                            ...
                            <a href="{{ route('admin.settings.security') }}" class="flex items-center p-4 bg-red-50 rounded-lg hover:bg-red-100 transition">
                            ...
                            <a href="{{ route('admin.settings.backup') }}" class="flex items-center p-4 bg-indigo-50 rounded-lg hover:bg-indigo-100 transition">
                            ...
                            <a href="{{ route('admin.settings.logs') }}" class="flex items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                            ...
                            <a href="{{ route('admin.settings.cache') }}" class="flex items-center p-4 bg-teal-50 rounded-lg hover:bg-teal-100 transition">
                            ...
                            <a href="{{ route('admin.settings.general') }}" class="flex items-center p-4 bg-pink-50 rounded-lg hover:bg-pink-100 transition">
                            ...
                            <a href="{{ route('admin.settings.images') }}" class="flex items-center p-4 bg-rose-50 rounded-lg hover:bg-rose-100 transition">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="text-sm font-medium text-gray-900">{{ App\Models\Artwork::count() }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-sm text-gray-500">Total Sales</span>
                            <span class="text-sm font-medium text-gray-900">${{ number_format(App\Models\Transaction::where('status', 'completed')->sum('amount'), 0) }}</span>
                        </div>
                        <div class="flex justify-between">
                    ...
                    <div class="space-y-3">
                        ...
                        @foreach($recentUsers as $user)
                            <div class="flex items-center space-x-3">
                                <img src="{{ $user->avatar ?? 'https://ui-avatars.com/api/?name=' . urlencode($user->name) . '&background=random&size=128' }}" 
                                     alt="{{ $user->name }}" 
                                     class="h-8 w-8 rounded-full object-cover">
                                <div class="flex-1 min-w-0">
                                    <p class="text-sm font-medium text-gray-900 truncate">{{ $user->name }}</p>
                                    <p class="text-xs text-gray-500">New {{ $user->role }}</p>
                                </div>
                            </div>
                        @endforeach
                    </div>
