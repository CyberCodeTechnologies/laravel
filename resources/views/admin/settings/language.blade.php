...
@section('title', 'Language Settings - Admin')
@section('meta-description', 'Configure language settings on Panchi Gallery')

@section('header', 'Language Settings')
            ...
            <div class="bg-blue-50 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-blue-900">{{ config('app.locale', 'en') }}</p>
            ...
            <div class="bg-green-50 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-green-900">{{ count($enabledLanguages ?? ['en', 'my']) }}</p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                <form method="POST" action="{{ route('admin.settings.language.update') }}" class="bg-white rounded-lg shadow-md">
                    @csrf
                    <div class="p-6">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <select id="default_language" name="default_language" required
                                    ...
                                    <option value="en" {{ ($defaultLanguage ?? config('app.locale')) === 'en' ? 'selected' : '' }}>English</option>
                                    <option value="my" {{ ($defaultLanguage ?? config('app.locale')) === 'my' ? 'selected' : '' }}>Myanmar (Burmese)</option>
                                </select>
                                ...
                                <div class="space-y-2">
                                    <label class="flex items-center p-3 border border-gray-300 rounded-lg hover:bg-gray-50 cursor-pointer">
                                        <input type="checkbox" name="enabled_languages[]" value="en" 
                                               {{ in_array('en', $enabledLanguages ?? ['en', 'my']) ? 'checked' : '' }}
                                    ...
                                    <label class="flex items-center p-3 border border-gray-300 rounded-lg hover:bg-gray-50 cursor-pointer">
                                        <input type="checkbox" name="enabled_languages[]" value="my" 
                                               {{ in_array('my', $enabledLanguages ?? ['en', 'my']) ? 'checked' : '' }}
                                               class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                        <div class="ml-3">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between">
                            ...
                            <span class="text-sm font-medium text-gray-900">{{ app()->getLocale() }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-sm text-gray-500">Fallback Locale</span>
                            <span class="text-sm font-medium text-gray-900">{{ config('app.fallback_locale', 'en') }}</span>
                        </div>
                        <div class="flex justify-between">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="space-y-3">
                        <a href="{{ route('admin.settings.translations') }}" class="flex items-center p-3 bg-blue-50 rounded-lg hover:bg-blue-100 transition">
