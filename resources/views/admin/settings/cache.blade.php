...
@section('title', 'Cache Settings - Admin')
@section('meta-description', 'Configure cache settings on Panchi Gallery')

@section('header', 'Cache Settings')
            ...
            <div class="bg-teal-50 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-teal-900">{{ strtoupper(config('cache.default')) }}</p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-2">
                <form method="POST" action="{{ route('admin.settings.cache.update') }}" class="bg-white rounded-lg shadow-md mb-6">
                    @csrf
                    <div class="p-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="number" id="cache_ttl" name="cache_ttl" value="{{ $cacheTtl }}" min="1" max="10080"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500">
                            ...
                            <div>
                                <label class="flex items-center">
                                    <input type="checkbox" name="enable_page_cache" value="1" {{ $enablePageCache ? 'checked' : '' }}
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="text-sm font-medium text-gray-900">{{ config('cache.prefix', 'laravel_cache') }}</span>
                        </div>
                    </div>
                </div>
            </div>
