...
@section('title', 'Shipping Settings - Admin')
@section('meta-description', 'Configure shipping settings on Panchi Gallery')
            ...
            <div class="bg-orange-50 rounded-lg p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-orange-900">{{ App\Models\Shipment::where('status', 'in_transit')->count() }}</p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-2">
                <form method="POST" action="{{ route('admin.settings.shipping.update') }}" class="bg-white rounded-lg shadow-md">
                    @csrf
                    <div class="p-6">
                        ...
                        <div class="space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="number" id="standard_shipping_cost" name="standard_shipping_cost" value="{{ App\Models\GeneralSetting::getValue('standard_shipping_cost', 15) }}" step="0.01" min="0"
                                ...
                                <div>
                                    ...
                                    <input type="number" id="express_shipping_cost" name="express_shipping_cost" value="{{ App\Models\GeneralSetting::getValue('express_shipping_cost', 30) }}" step="0.01" min="0"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="free_shipping_threshold" name="free_shipping_threshold" value="{{ App\Models\GeneralSetting::getValue('free_shipping_threshold', 500) }}" step="0.01" min="0"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500">
                            ...
                            <div>
                                ...
                                <input type="number" id="processing_days" name="processing_days" value="{{ App\Models\GeneralSetting::getValue('processing_days', 3) }}" min="1" max="30"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500">
                            ...
                            <div>
                                <label class="flex items-center">
                                    <input type="checkbox" name="international_shipping" value="1" {{ App\Models\GeneralSetting::getValue('international_enabled', true) ? 'checked' : '' }}
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between">
                            ...
                            <span class="text-sm font-medium text-gray-900">{{ App\Models\Shipment::where('status', 'pending')->count() }}</span>
                        </div>
                        <div class="flex justify-between">
