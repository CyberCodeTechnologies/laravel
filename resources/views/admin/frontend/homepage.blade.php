...
@section('title', 'Homepage Management - Panchi Gallery')

@section('header', 'Homepage Management')
...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="card-luxury rounded-xl overflow-hidden">
            ...
            <div class="p-6">
                ...
                <div class="space-y-3">
                    @forelse($sections['hero'] as $content)
                        <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                            <span class="text-sm font-medium">{{ $content->key }}</span>
                            <span class="text-xs text-gray-500">{{ $content->is_active ? 'Active' : 'Inactive' }}</span>
                        </div>
                    @empty
                        <p class="text-gray-500 text-sm italic">No hero content configured</p>
                    @endforelse
                </div>
                <form action="{{ route('admin.frontend.homepage.update', 'hero') }}" method="POST" class="mt-4">
                    @csrf
        ...
        <div class="card-luxury rounded-xl overflow-hidden">
            ...
            <div class="p-6">
                ...
                <div class="space-y-3">
                    @forelse($sections['featured'] as $content)
                        <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                            <span class="text-sm font-medium">{{ $content->key }}</span>
                            <span class="text-xs text-gray-500">{{ $content->is_active ? 'Active' : 'Inactive' }}</span>
                        </div>
                ...
                <form action="{{ route('admin.frontend.homepage.update', 'featured') }}" method="POST" class="mt-4">
                    @csrf
                    <button type="submit" class="btn-luxury w-full py-2 rounded-lg text-white text-sm">
        ...
        <div class="card-luxury rounded-xl overflow-hidden">
            ...
            <div class="p-6">
                ...
                <div class="space-y-3">
                    @forelse($sections['about'] as $content)
                        <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                            <span class="text-sm font-medium">{{ $content->key }}</span>
                            <span class="text-xs text-gray-500">{{ $content->is_active ? 'Active' : 'Inactive' }}</span>
                        </div>
                ...
                <form action="{{ route('admin.frontend.homepage.update', 'about') }}" method="POST" class="mt-4">
                    @csrf
                    <button type="submit" class="btn-luxury w-full py-2 rounded-lg text-white text-sm">
                        Edit About Section
                    </button>
        ...
        <div class="card-luxury rounded-xl overflow-hidden">
            ...
            <div class="p-6">
                ...
                <div class="space-y-3">
                    @forelse($sections['artists'] as $content)
                        <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                            <span class="text-sm font-medium">{{ $content->key }}</span>
                            <span class="text-xs text-gray-500">{{ $content->is_active ? 'Active' : 'Inactive' }}</span>
                        </div>
                ...
                <form action="{{ route('admin.frontend.homepage.update', 'artists') }}" method="POST" class="mt-4">
                    @csrf
                    <button type="submit" class="btn-luxury w-full py-2 rounded-lg text-white text-sm">
        ...
        <div class="card-luxury rounded-xl overflow-hidden">
            ...
            <div class="p-6">
                ...
                <div class="space-y-3">
                    @forelse($sections['categories'] as $content)
                        <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                            <span class="text-sm font-medium">{{ $content->key }}</span>
                            <span class="text-xs text-gray-500">{{ $content->is_active ? 'Active' : 'Inactive' }}</span>
                        </div>
                ...
                <form action="{{ route('admin.frontend.homepage.update', 'categories') }}" method="POST" class="mt-4">
                    @csrf
                    <button type="submit" class="btn-luxury w-full py-2 rounded-lg text-white text-sm">
        ...
        <div class="card-luxury rounded-xl overflow-hidden">
            ...
            <div class="p-6">
                ...
                <div class="space-y-3">
                    @forelse($sections['cta'] as $content)
                        <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                            <span class="text-sm font-medium">{{ $content->key }}</span>
                            <span class="text-xs text-gray-500">{{ $content->is_active ? 'Active' : 'Inactive' }}</span>
                        </div>
                ...
                <form action="{{ route('admin.frontend.homepage.update', 'cta') }}" method="POST" class="mt-4">
                    @csrf
                    <button type="submit" class="btn-luxury w-full py-2 rounded-lg text-white text-sm">
                        Edit CTA Section
                    </button>
    ...
    <div class="bg-gray-50 rounded-xl p-6">
        ...
        <div class="flex flex-wrap gap-3">
            <a href="{{ route('admin.page-contents.index') }}?page=home" class="btn-elegant px-4 py-2 rounded-lg text-sm">
