...
@section('meta-description', 'Create new FAQ for Panchi Gallery')
...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-md">
        ...
        <form action="{{ route('admin.support.faq.store') }}" method="POST" class="p-6">
            @csrf
