...
@section('title', 'Edit Page Content - Admin - Panchi Gallery')
@section('header', 'Edit Page Content')
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <select id="page" name="page" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <option value="home" {{ old('page', $pageContent->page) == 'home' ? 'selected' : '' }}>Home</option>
                        <option value="about" {{ old('page', $pageContent->page) == 'about' ? 'selected' : '' }}>About</option>
                        <option value="contact" {{ old('page', $pageContent->page) == 'contact' ? 'selected' : '' }}>Contact</option>
                        <option value="faq" {{ old('page', $pageContent->page) == 'faq' ? 'selected' : '' }}>FAQ</option>
                        <option value="privacy" {{ old('page', $pageContent->page) == 'privacy' ? 'selected' : '' }}>Privacy Policy</option>
                        <option value="terms" {{ old('page', $pageContent->page) == 'terms' ? 'selected' : '' }}>Terms of Service</option>
                    </select>
                    @error('page')
                ...
                <div>
                    ...
                    <input type="text" id="section" name="section" value="{{ old('section', $pageContent->section) }}" required
                ...
                <div>
                    ...
                    <input type="text" id="key" name="key" value="{{ old('key', $pageContent->key) }}" required
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div>
                    ...
                    <textarea id="content_en" name="content_en" rows="4" required
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                              placeholder="Enter English content">{{ old('content_en', $pageContent->content_en) }}</textarea>
                    @error('content_en')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea id="content_my" name="content_my" rows="4"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                              placeholder="Enter Myanmar content (optional)">{{ old('content_my', $pageContent->content_my) }}</textarea>
                    @error('content_my')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <select id="type" name="type" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        <option value="text" {{ old('type', $pageContent->type) == 'text' ? 'selected' : '' }}>Text</option>
                        <option value="html" {{ old('type', $pageContent->type) == 'html' ? 'selected' : '' }}>HTML</option>
                        <option value="image" {{ old('type', $pageContent->type) == 'image' ? 'selected' : '' }}>Image URL</option>
                    </select>
                    @error('type')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="number" id="sort_order" name="sort_order" min="0" value="{{ old('sort_order', $pageContent->sort_order) }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
