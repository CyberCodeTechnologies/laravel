...
@section('title', cms_content('about_title', __('messages.about_title')) . ' - Panchi Gallery')
@section('meta-description', cms_content('about_hero_description', __('messages.about_hero_description')))
@section('meta-keywords', 'Panchi Gallery about, Myanmar art gallery, art marketplace, authentic artwork, art certificates, art platform mission, buy sell art Myanmar')
@section('meta-image', \App\Services\ImageSyncService::getSynchronizedImage('site_og_image', asset('images/og-default.jpg')))
...
<script type="application/ld+json">
{
    ...
    "url": "{{ route('about') }}",
    "description": "{{ cms_content('about_hero_description', __('messages.about_hero_description')) }}",
    "mainEntity": {
        "@@type": "Organization",
        "name": "Panchi Gallery",
        "url": "{{ url('/') }}"
...
<div class="min-h-screen bg-white">
    ...
    <section class="relative h-screen flex items-center justify-center overflow-hidden">
        <div class="absolute inset-0">
            <img src="{{ \App\Services\ImageSyncService::getSynchronizedImage('about_hero_background', asset('images/placeholder-artwork.jpg')) }}" 
        ...
        <div class="relative z-10 text-center px-4 max-w-5xl mx-auto">
            <div class="animate-fade-in-up">
                <h1 class="text-5xl md:text-7xl font-serif font-bold text-white mb-6 leading-tight">
                    {!! nl2br(e(general_setting('about_hero_title', __('messages.about_hero_title')))) !!}
                </h1>
                <p class="text-2xl md:text-3xl font-light text-white/90 mb-8 leading-relaxed">
                    {!! nl2br(e(general_setting('about_hero_subtitle_1', __('messages.about_hero_subtitle_1')))) !!}<br>{!! e(general_setting('about_hero_subtitle_2', __('messages.about_hero_subtitle_2'))) !!}
                </p>
                <p class="text-lg md:text-xl text-white/80 mb-12 max-w-3xl mx-auto leading-relaxed">
                    {{ general_setting('about_hero_description', __('messages.about_hero_description')) }}
                </p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div class="space-y-6">
                    <div class="inline-flex items-center px-4 py-2 bg-black/10 rounded-full">
                        <span class="text-sm font-semibold text-black">{{ general_setting('about_mission_badge', __('messages.mission_badge')) }}</span>
                    </div>
                    <h2 class="text-4xl md:text-5xl font-serif font-bold text-gray-900 leading-tight">
                        {{ general_setting('about_mission_title', __('messages.mission_title')) }}
                    </h2>
                    <div class="space-y-4 text-lg text-gray-600 leading-relaxed">
                        <p>
                            {{ general_setting('about_mission_p1', __('messages.mission_p1')) }}
                        </p>
                        <p>
                            {{ general_setting('about_mission_p2', __('messages.mission_p2')) }}
                        </p>
                        <p>
                            {{ general_setting('about_mission_p3', __('messages.mission_p3')) }}
                        </p>
                    </div>
                </div>
                ...
                <div class="relative group">
                    ...
                    <img src="{{ \App\Services\ImageSyncService::getSynchronizedImage('about_mission_image', asset('images/placeholder-artwork.jpg')) }}" 
                         alt="Art Gallery" 
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="group text-center p-8 rounded-2xl bg-gradient-to-br from-gray-50 to-white hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-4">{{ __('messages.authenticity') }}</h3>
                    <p class="text-gray-600 leading-relaxed">
                        {{ __('messages.authenticity_text') }}
                    </p>
                </div>
                ...
                <div class="group text-center p-8 rounded-2xl bg-gradient-to-br from-gray-50 to-white hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-4">{{ __('messages.quality') }}</h3>
                    <p class="text-gray-600 leading-relaxed">
                ...
                <div class="group text-center p-8 rounded-2xl bg-gradient-to-br from-gray-50 to-white hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-4">{{ __('messages.transparency') }}</h3>
                    <p class="text-gray-600 leading-relaxed">
                        {{ __('messages.transparency_text') }}
                    </p>
                </div>
                ...
                <div class="group text-center p-8 rounded-2xl bg-gradient-to-br from-gray-50 to-white hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-4">{{ __('messages.empowerment') }}</h3>
                    <p class="text-gray-600 leading-relaxed">
                        {{ __('messages.empowerment_text') }}
                    </p>
                </div>
            </div>
        </div>
    ...
    <section class="py-24 bg-gradient-to-br from-gray-50 to-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <div class="inline-flex items-center px-4 py-2 bg-black/10 rounded-full mb-6">
                    <span class="text-sm font-semibold text-black">{{ __('messages.how_it_works_badge') }}</span>
                </div>
                <h2 class="text-4xl md:text-5xl font-serif font-bold text-gray-900 mb-6">
            ...
            <div class="relative">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
                    <div class="group text-center">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 mb-4">{{ __('messages.discover') }}</h3>
                    ...
                    <div class="group text-center">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 mb-4">{{ __('messages.verify') }}</h3>
                        <p class="text-gray-600 leading-relaxed text-lg">
                    ...
                    <div class="group text-center">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 mb-4">{{ __('messages.collect') }}</h3>
                        <p class="text-gray-600 leading-relaxed text-lg">
                            {{ __('messages.collect_text') }}
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <div class="inline-flex items-center px-4 py-2 bg-white/10 rounded-full mb-6 backdrop-blur-sm">
                    <span class="text-sm font-semibold text-white">{{ __('messages.stats_badge') }}</span>
                </div>
                <h2 class="text-4xl md:text-5xl font-serif font-bold text-white mb-6">
                    {{ __('messages.stats_title') }}
                </h2>
                <p class="text-xl text-white/80 max-w-3xl mx-auto">
                    {{ __('messages.stats_subtitle') }}
                </p>
            </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                <div class="group">
                    <div class="text-5xl md:text-6xl font-bold text-white mb-2 group-hover:scale-110 transition-transform duration-300">
                        {{ $stats['verified_artists'] }}
                    </div>
                    <p class="text-white/70 text-lg">{{ __('messages.verified_artists') }}</p>
                </div>
                <div class="group">
                    <div class="text-5xl md:text-6xl font-bold text-white mb-2 group-hover:scale-110 transition-transform duration-300">
                        {{ $stats['artworks_listed'] }}
                    </div>
                    <p class="text-white/70 text-lg">{{ __('messages.artworks_listed') }}</p>
                </div>
                <div class="group">
                    <div class="text-5xl md:text-6xl font-bold text-white mb-2 group-hover:scale-110 transition-transform duration-300">
                        {{ $stats['happy_collectors'] }}
                    </div>
                    <p class="text-white/70 text-lg">{{ __('messages.happy_collectors') }}</p>
                </div>
                <div class="group">
                    <div class="text-5xl md:text-6xl font-bold text-white mb-2 group-hover:scale-110 transition-transform duration-300">
                        {{ $stats['art_sales'] }}
                    </div>
                    <p class="text-white/70 text-lg">{{ __('messages.art_sales') }}</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
        ...
        <div class="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="inline-flex items-center px-4 py-2 bg-black/10 rounded-full mb-6">
                <span class="text-sm font-semibold text-black">{{ __('messages.cta_badge') }}</span>
            </div>
            <h2 class="text-4xl md:text-5xl font-serif font-bold text-gray-900 mb-6">
            ...
            <div class="flex flex-col sm:flex-row gap-6 justify-center">
                <a href="{{ route('register') }}?role=artist" 
                   class="group px-8 py-4 bg-black text-white font-semibold rounded-lg hover:bg-gray-800 transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center justify-center">
                    ...
                    {{ __('messages.join_as_artist') }}
                </a>
                <a href="{{ route('register') }}?role=collector" 
