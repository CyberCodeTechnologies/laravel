...
@section('title', 'Categories - Panchi Gallery')
@section('meta-description', 'Browse artwork categories at Panchi Gallery. Find your perfect piece from our curated collection of Myanmar art.')
@section('meta-keywords', 'art categories, Myanmar art categories, painting styles, art types, art mediums, browse art by category, Panchi Gallery categories')
                        ...
                        <a href="{{ route('categories.show', $category->slug) }}" class="block">
                            ...
                            <div class="p-4">
                                <p class="text-sm text-gray-600">
                                    {{ $category->artworks()->count() }} artworks
                                </p>
                            </div>
                        </a>
                    </div>
