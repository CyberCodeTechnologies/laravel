...
@section('title', 'Create Artwork - Panchi Gallery')
...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form action="{{ route('artist.artworks.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow-sm p-8">
            @csrf
